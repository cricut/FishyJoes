...
class NAPITests: XCTestCase {
    ...
    let CC = "/Library/Developer/Toolchains/swift-wasm-5.7.3-RELEASE.xctoolchain/usr/bin/clang"
    let LD = "/Library/Developer/Toolchains/swift-wasm-5.7.3-RELEASE.xctoolchain/usr/bin/swiftc"
    let CFLAGS = [
        "-target", "wasm32-unknown-wasi",
        "--sysroot", "/Library/Developer/Toolchains/swift-wasm-5.7.3-RELEASE.xctoolchain/usr/share/wasi-sysroot",
        "-I/opt/homebrew/include/node",
        "-I/usr/local/include/node",
    ]
    let LDFLAGS = [
        "-L/Library/Developer/Toolchains/swift-wasm-5.7.3-RELEASE.xctoolchain/usr/lib",
        "-sdk", "/Library/Developer/Toolchains/swift-wasm-5.7.3-RELEASE.xctoolchain/usr/share/wasi-sysroot",
        "-lswiftCore",
        "-emit-executable",
        "-target", "wasm32-unknown-wasi",

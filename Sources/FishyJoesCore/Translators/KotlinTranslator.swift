...
final class KotlinTranslator: Translator {
    ...
    func translate(method: Method, context: FishyJoesContext, typeName: String) -> [SourceFragment] {
        ...
        allMethods[containingNamespace, default: []].append((javaName, jniSignature, cMethod, method.isDefaultImplementation))
    ...
    func translate(variable: Variable, context: FishyJoesContext) -> [SourceFragment] {
        ...
        allMethods[sourceTypeName, default: []].append((jvmGetName, "()" + jniSignature, cGetName, false))
        ...
        if variable.isPubliclyWritable {
            ...
            allMethods[sourceTypeName, default: []].append((jvmSetName, "(\(jniSignature))V", cSetName, false))
            if let deprecation = variable.deprecation {
                fragment.output(deprecation.swiftDeprecation)
            }

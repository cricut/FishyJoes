...
final class KotlinTranslator: Translator {
    ...
    func translate(method: Method, context: FishyJoesContext) -> [SourceFragment] {
        ...
        let fragment = context.swiftFragment(
            "Sources/JavaInterface/\(containingNamespace)+javadecl.swift",
    ...
    func setupFragments(context: FishyJoesContext, generatedTypes: [BetterType]) -> [SourceFragment] {
        let typeSetupFragment = context.swiftFragment(
            "Sources/JavaInterface/TypeSetup.swift",
            additionalImports: ["Foundation", "FishyJoesJavaRuntime"]
        )
        ...
        let ktFragment = SourceFragment(
            sourceryDestination: "file:bindings/generated/kotlin/src/generated/kotlin/com/cricut/\(module.name.lowercased())/\(repName).kt"
        )
        ...
        let exportFragment = SourceFragment(sourceryDestination: "file:Sources/JavaInterface/@_exported.swift")

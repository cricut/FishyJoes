...
final class KotlinTranslator: Translator {
    ...
    func translate(variable: Variable, context: FishyJoesContext, betterType: BetterType) -> [SourceFragment] {
        ...
        allMethods[sourceTypeName, default: []].insert(MethodInfo(javaName: jvmGetName, signature: "()" + jniSignature, cName: cGetName, isProtocolDefault: variable.isDefaultImplementation))

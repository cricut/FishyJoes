...
final class IotaTranslator: Translator {
    ...
    func translate(method: Method, context: FishyJoesContext, betterType: BetterType) -> [SourceFragment] {
        ...
        if !method.isStatic {
            formals.append((name: "_iotaThis", type: "HostObject"))
        }
        formals.append(
        ...
        formals.append((name: "_exn", type: "OutHostException"))
        ...
        let returnSignature = method.isAsync ? "HostObject" : "\(returnType.converterType.name).CType"

...
typedef int (*FishyJoes_StringUtf8LengthFn)(foreignObject object, foreignOutExn exn);
typedef void (*FishyJoes_StringGetUtf8Fn)(foreignObject object, char *outBytes, foreignOutExn exn);
typedef foreignObject (*FishyJoes_StringUtf8ConstructorFn)(const char *bytes, int length, foreignOutExn exn);

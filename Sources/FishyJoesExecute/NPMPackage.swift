struct NPMPackage: Codable {
    static func nameFor(config: ProjectConfig, platform: Platform) -> String {
    ...
    init(config: ProjectConfig, platform: Platform, version: String, dependencies: [String: String]?) {

...
// MARK: - Specialized Type Conversion
// public enum PromiseConverter<WrappedConverter: NodeConverter>: NodeConverter {
//    public typealias SwiftType = () async throws -> WrappedConverter.SwiftType
//    
//    public static func fromNode(_ value: NAPI.Value, env: NAPI.Env) throws -> SwiftType {
//        guard try env.isPromise(value) else {
//            throw JSException(message: "Expected a promise but found another NAPI.Value type")
//        }
//        
...
//        }
//        
//        let thenFunction = try env.createFunction(
//            nil,
//            { env, info in
//                callbackBody(env, info, name: "", expectedArgumentCount: 1) { env in
//                    fatalError()
//                }
//            },
//            nil
//        )
//        let catchFunction = try env.createFunction(
//            nil,
//            { env, info in
//                callbackBody(env, info, name: "", expectedArgumentCount: 1) { env in
//                    fatalError()
...
////            try env.resolveDeferred(deferred, WrappedConverter.toNode(value, env: env))

...
typedef _FishyJoesCommonRuntime_Env_setup =
    Env Function(
...
typedef _FishyJoesCommonRuntime_dartWorkScheduler_setup<R, I64> =
    R Function(Env env, I64 sendPortID, ffi.Pointer dart_PostInteger_DL);

typedef _FishyJoesCommonRuntime_AnyBox_releaseRef<R> =
    R Function(
      Env env,
      ConsumedRef swiftReference,
      OutCreatedRef exn,
    );
typedef _FishyJoesCommonRuntime_AnyBox_toString =
    CreatedRef Function(
      Env env,
      UnownedRef swiftReference,
      OutCreatedRef exn,
    );
typedef _FishyJoesCommonRuntime_runScheduledWork<R> = R Function(Env env, ffi.Pointer context, OutCreatedRef exn);
...
typedef _FishyJoesCommonRuntime_AnyBox_setup<R> =
    R Function(
      Env env,
...
class Loader {
  ...
  Loader._() {
    env =
        _dylib.lookupFunction<_FishyJoesCommonRuntime_Env_setup, _FishyJoesCommonRuntime_Env_setup>(
    ...
    >('FishyJoesCommonRuntime_dartWorkScheduler_setup')(env, port.sendPort.nativePort, DartApiDL.shared.postIntegerPtr);

    Loader._dylib
        .lookupFunction<_FishyJoesCommonRuntime_AnyBox_setup<ffi.Void>, _FishyJoesCommonRuntime_AnyBox_setup<void>>(
  ...
  static final fishyJoesCommonRuntime_AnyBox_releaseRef = Loader._dylib
      .lookupFunction<
        _FishyJoesCommonRuntime_AnyBox_releaseRef<ffi.Void>,
        _FishyJoesCommonRuntime_AnyBox_releaseRef<void>
      >('FishyJoesCommonRuntime_AnyBox_releaseRef');

  static final fishyJoesCommonRuntime_AnyBox_toString = Loader._dylib
      .lookupFunction<_FishyJoesCommonRuntime_AnyBox_toString, _FishyJoesCommonRuntime_AnyBox_toString>(
        'FishyJoesCommonRuntime_AnyBox_toString',
      );

  static final fishyJoesCommonRuntime_runScheduledWork = Loader._dylib
      .lookupFunction<
        _FishyJoesCommonRuntime_runScheduledWork<ffi.Void>,
        _FishyJoesCommonRuntime_runScheduledWork<void>
      >('FishyJoesCommonRuntime_runScheduledWork');

  static final fishyJoesCommonRuntime_dartWorkScheduler = Loader._dylib
      .lookup<ffi.NativeFunction<_EnvScheduleThreadWorkFn<ffi.Void>>>('FishyJoesCommonRuntime_dartWorkScheduler');
}

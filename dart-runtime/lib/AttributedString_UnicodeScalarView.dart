...
class AttributedString_UnicodeScalarView extends SwiftReference with Iterable<int> {
  ...
  static CreatedRef ffi_new(ffi.Pointer ref, OutCreatedRef exn) =>
      check((exn) => createRef(AttributedString_UnicodeScalarView(ref)));
  ...
  AttributedString_Index get startIndex => GCRef.using(
    ...
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_Index>(
        f__iota_get_Foundation_AttributedString_UnicodeScalarView_startIndex(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_Index get endIndex => GCRef.using(
    ...
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_Index>(
        f__iota_get_Foundation_AttributedString_UnicodeScalarView_endIndex(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_Index indexBefore(
    ...
    (_thisHandle) => GCRef.using(
      index,
      (_indexHandle) => consumeCreatedRef<AttributedString_Index>(
        check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_UnicodeScalarView_indexBefore(
            Loader.shared.env,
            _thisHandle.ptr,
            _indexHandle.ptr,
            _exn,
  ...
  AttributedString_Index indexAfter(
    ...
    (_thisHandle) => GCRef.using(
      ...
      (_indexHandle) => consumeCreatedRef<AttributedString_Index>(
        check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_UnicodeScalarView_indexAfter(
            Loader.shared.env,
            _thisHandle.ptr,
            _indexHandle.ptr,
            _exn,
  ...
  int elementAtIndex(
    ...
    (_thisHandle) => GCRef.using(
      index,
      (_indexHandle) => check(
        (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_UnicodeScalarView_elementAt(
          Loader.shared.env,
          _thisHandle.ptr,
          _indexHandle.ptr,
          _exn,
  ...
  static late int Function(Env env, UnownedRef _this, UnownedRef index, OutCreatedRef _exn)
...
class AttributedString_UnicodeScalarView_Iterator implements Iterator<int> {
  ...
  AttributedString_UnicodeScalarView_Iterator(AttributedString_UnicodeScalarView view) : view = view, index = null {}

...
class AttributeContainer_FoundationAttributes extends SwiftReference {
  ...
  static CreatedRef ffi_new(ffi.Pointer ref, OutCreatedRef exn) =>
      check((exn) => createRef(AttributeContainer_FoundationAttributes(ref)));

  /// A link attribute.
  /// <!-- FishyJoes.export(link) -->
  Uri? get link => GCRef.using(
    this,
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<Uri?>(
  ...
  set link(Uri? value) {
    GCRef.using(
      ...
      (_thisHandle) => GCRef.using(
        value,
        (_valueHandle) => check(
          (exn) => f__iota_set_FishyJoesCommonRuntime_AttributeContainer_FoundationAttributes_link(
            Loader.shared.env,
            _thisHandle.ptr,
            _valueHandle.ptr,
            exn,
  ...
  String? get languageIdentifier => GCRef.using(
    this,
    (_thisHandle) => check(
  ...
  set languageIdentifier(String? value) {
    GCRef.using(
      ...
      (_thisHandle) => GCRef.using(
        value,
        (_valueHandle) => check(
          (exn) => f__iota_set_FishyJoesCommonRuntime_AttributeContainer_FoundationAttributes_languageIdentifier(
            Loader.shared.env,
            _thisHandle.ptr,
            _valueHandle.ptr,
            exn,
  ...
  int get hashCode => GCRef.using(
    this,
    (_thisHandle) => check(
      (exn) => f__iota_get_FishyJoesCommonRuntime_AttributeContainer_FoundationAttributes_hash(
        Loader.shared.env,
        _thisHandle.ptr,
        exn,
      ),
  ...
  static AttributeContainer_FoundationAttributes createEmpty() =>
      consumeCreatedRef<AttributeContainer_FoundationAttributes>(
        check(
          (OutCreatedRef _exn) => f__iota_FishyJoesCommonRuntime_AttributeContainer_FoundationAttributes_createEmpty(
            Loader.shared.env,
            _exn,
          ),
        ),
  ...
  static AttributeContainer_FoundationAttributes createFromContainer(
    ...
    container,
    (_containerHandle) => consumeCreatedRef<AttributeContainer_FoundationAttributes>(
      check(
        (OutCreatedRef _exn) =>
            f__iota_FishyJoesCommonRuntime_AttributeContainer_FoundationAttributes_createFromContainer(
              Loader.shared.env,
              _containerHandle.ptr,
              _exn,
            ),
      ),
    ),
  ...
  bool operator ==(
    ...
    (thisHandle) => GCRef.using(
      other as AttributeContainer_FoundationAttributes,
      (otherHandle) => check(
        (exn) => f__iota_FishyJoesCommonRuntime_AttributeContainer_FoundationAttributes_equals(
          Loader.shared.env,
          thisHandle.ptr,
          otherHandle.ptr,
          exn,
  ...
  AttributeContainer asContainer() => GCRef.using(
    this,
    (thisHandle) => consumeCreatedRef<AttributeContainer>(
      check(
        (exn) => f__iota_FishyJoesCommonRuntime_AttributeContainer_FoundationAttributes_asContainer(
          Loader.shared.env,
          thisHandle.ptr,
          exn,
        ),
  ...
  static late CreatedRef Function(Env env, UnownedRef container, OutCreatedRef _exn)
  f__iota_FishyJoesCommonRuntime_AttributeContainer_FoundationAttributes_createFromContainer;
  ...
  static late CreatedRef Function(Env env, UnownedRef _this, OutCreatedRef _exn)
  f__iota_get_FishyJoesCommonRuntime_AttributeContainer_FoundationAttributes_link;
  static late void Function(Env env, UnownedRef _this, UnownedRef languageIdentifier, OutCreatedRef _exn)
  f__iota_set_FishyJoesCommonRuntime_AttributeContainer_FoundationAttributes_languageIdentifier;
  static late void Function(Env env, UnownedRef _this, UnownedRef link, OutCreatedRef _exn)

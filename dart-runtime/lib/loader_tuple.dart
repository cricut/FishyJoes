...
typedef _TupleGetter = CreatedRef Function(UnownedRef context, UnownedRef obj, OutCreatedRef exn);
typedef _TupleConstructor =
    CreatedRef Function(UnownedRef context, ffi.Pointer<UnownedRef> elements, OutCreatedRef exn);

typedef _FishyJoesCommonRuntime_tuple_setup<R> =
    R Function(
      Env env,
...
class _TupleConversions {
  ...
  static CreatedRef _constructor(UnownedRef context, ffi.Pointer<UnownedRef> elements, OutCreatedRef exn) =>
      catchingRef(exn, () => peekRef<_TupleConversions>(context).constructor(elements));

  static CreatedRef _get0(UnownedRef context, UnownedRef tuple, OutCreatedRef exn) =>
      catchingRef(exn, () => peekRef<_TupleConversions>(context).get0!(tuple));
  static CreatedRef _get1(UnownedRef context, UnownedRef tuple, OutCreatedRef exn) =>
      catchingRef(exn, () => peekRef<_TupleConversions>(context).get1!(tuple));
  static CreatedRef _get2(UnownedRef context, UnownedRef tuple, OutCreatedRef exn) =>
      catchingRef(exn, () => peekRef<_TupleConversions>(context).get2!(tuple));
  static CreatedRef _get3(UnownedRef context, UnownedRef tuple, OutCreatedRef exn) =>
      catchingRef(exn, () => peekRef<_TupleConversions>(context).get3!(tuple));
  static CreatedRef _get4(UnownedRef context, UnownedRef tuple, OutCreatedRef exn) =>
      catchingRef(exn, () => peekRef<_TupleConversions>(context).get4!(tuple));
  static CreatedRef _get5(UnownedRef context, UnownedRef tuple, OutCreatedRef exn) =>
      catchingRef(exn, () => peekRef<_TupleConversions>(context).get5!(tuple));

  static final ffi.Pointer<ffi.NativeFunction<_TupleConstructor>> constructorPtr = ffi.Pointer.fromFunction(
    _constructor,
  );
  static final ffi.Pointer<ffi.NativeFunction<_TupleGetter>> get0Ptr = ffi.Pointer.fromFunction(_get0);
  static final ffi.Pointer<ffi.NativeFunction<_TupleGetter>> get1Ptr = ffi.Pointer.fromFunction(_get1);
  static final ffi.Pointer<ffi.NativeFunction<_TupleGetter>> get2Ptr = ffi.Pointer.fromFunction(_get2);
  static final ffi.Pointer<ffi.NativeFunction<_TupleGetter>> get3Ptr = ffi.Pointer.fromFunction(_get3);
  static final ffi.Pointer<ffi.NativeFunction<_TupleGetter>> get4Ptr = ffi.Pointer.fromFunction(_get4);
  static final ffi.Pointer<ffi.NativeFunction<_TupleGetter>> get5Ptr = ffi.Pointer.fromFunction(_get5);
}

extension LoaderTuple on Loader {
  static final _fishyJoesCommonRuntime_TupleConverter_setup = Loader._dylib
      .lookupFunction<_FishyJoesCommonRuntime_tuple_setup<ffi.Void>, _FishyJoesCommonRuntime_tuple_setup<void>>(
  ...
  void FishyJoesCommonRuntime_Tuple2Converter_setup<T0, T1>(Env env, String name, OutCreatedRef exn) {
  ...
  void FishyJoesCommonRuntime_Tuple3Converter_setup<T0, T1, T2>(Env env, String name, OutCreatedRef exn) {
    _tupleConverterSetup(
      env,
      name,
      _TupleConversions(
  ...
  void FishyJoesCommonRuntime_Tuple4Converter_setup<T0, T1, T2, T3>(Env env, String name, OutCreatedRef exn) {
    _tupleConverterSetup(
      env,
      name,
      _TupleConversions(
  ...
  void FishyJoesCommonRuntime_Tuple5Converter_setup<T0, T1, T2, T3, T4>(Env env, String name, OutCreatedRef exn) {
    _tupleConverterSetup(
      env,
      name,
      _TupleConversions(
  ...
  void FishyJoesCommonRuntime_Tuple6Converter_setup<T0, T1, T2, T3, T4, T5>(Env env, String name, OutCreatedRef exn) {
    _tupleConverterSetup(
      env,
      name,
      _TupleConversions(

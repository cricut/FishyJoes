...
class AttributedString_CharacterView extends SwiftReference with Iterable<String> {
  ...
  static CreatedRef ffi_new(ffi.Pointer ref, OutCreatedRef exn) =>
      check((exn) => createRef(AttributedString_CharacterView(ref)));
  ...
  AttributedString_Index get startIndex => GCRef.using(
    ...
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_Index>(
        f__iota_get_Foundation_AttributedString_CharacterView_startIndex(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_Index get endIndex => GCRef.using(
    ...
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_Index>(
        f__iota_get_Foundation_AttributedString_CharacterView_endIndex(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_Index indexBefore(
    ...
    (_thisHandle) => GCRef.using(
      ...
      (_indexHandle) => consumeCreatedRef<AttributedString_Index>(
        check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_CharacterView_indexBefore(
            Loader.shared.env,
            _thisHandle.ptr,
            _indexHandle.ptr,
            _exn,
  ...
  AttributedString_Index indexAfter(
    ...
    (_thisHandle) => GCRef.using(
      ...
      (_indexHandle) => consumeCreatedRef<AttributedString_Index>(
        check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_CharacterView_indexAfter(
            Loader.shared.env,
            _thisHandle.ptr,
            _indexHandle.ptr,
            _exn,
  ...
  String elementAtIndex(
    ...
    (_thisHandle) => GCRef.using(
      index,
      (_indexHandle) => consumeCreatedRef<String>(
        check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_CharacterView_elementAt(
            Loader.shared.env,
            _thisHandle.ptr,
            _indexHandle.ptr,
            _exn,
...
class AttributedString_CharacterView_Iterator implements Iterator<String> {
  ...
  AttributedString_CharacterView_Iterator(AttributedString_CharacterView view) : view = view, index = null {}

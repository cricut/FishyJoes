...
class AttributeContainer extends SwiftReference {
    ...
    int get hashCode =>
        GCRef.using(this, (_thisHandle) =>
            check((exn) =>
                f__iota_get_FishyJoesCommonRuntime_AttributeContainer_hash(Loader.shared.env, _thisHandle.ptr, exn)
            )
        )
    ;
    ...
    void merge(
        ...
        GCRef.using(this, (_thisHandle) =>
            GCRef.using(other, (_otherHandle) =>
                check((OutCreatedRef _exn) => f__iota_FishyJoesCommonRuntime_AttributeContainer_merge(Loader.shared.env, _thisHandle.ptr, _otherHandle.ptr, keepCurrent, _exn))
            )
        )
    ;
    ...
    bool operator ==(
        ...
        GCRef.using(this, (thisHandle) =>
            GCRef.using(other as AttributeContainer, (otherHandle) =>
                check((exn) => f__iota_FishyJoesCommonRuntime_AttributeContainer_equals(Loader.shared.env, thisHandle.ptr, otherHandle.ptr, exn))))
    ;

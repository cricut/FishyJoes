...
class AttributedSubstring extends SwiftReference {
  ...
  static CreatedRef ffi_new(ffi.Pointer ref, OutCreatedRef exn) => check((exn) => createRef(AttributedSubstring(ref)));
  ...
  AttributedString get base => GCRef.using(
    this,
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString>(
        f__iota_get_Foundation_AttributedSubstring_base(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  String get string => GCRef.using(
    ...
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<String>(
        f__iota_get_Foundation_AttributedSubstring_string(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_Runs get runs => GCRef.using(
    ...
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_Runs>(
        f__iota_get_Foundation_AttributedSubstring_runs(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_CharacterView get characters => GCRef.using(
    ...
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_CharacterView>(
        f__iota_get_Foundation_AttributedSubstring_characters(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_UnicodeScalarView get unicodeScalars => GCRef.using(
    ...
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_UnicodeScalarView>(
        f__iota_get_Foundation_AttributedSubstring_unicodeScalars(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_Index get startIndex => GCRef.using(
    ...
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_Index>(
        f__iota_get_Foundation_AttributedSubstring_startIndex(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_Index get endIndex => GCRef.using(
    ...
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_Index>(
        f__iota_get_Foundation_AttributedSubstring_endIndex(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedSubstring get substring => GCRef.using(
    ...
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedSubstring>(
        f__iota_get_Foundation_AttributedSubstring_substring(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  @override
  int get hashCode => GCRef.using(
    this,
    (_thisHandle) =>
        check((exn) => f__iota_get_Foundation_AttributedSubstring_hash(Loader.shared.env, _thisHandle.ptr, exn)),
  );
  ...
  AttributedSubstring substringForRange(
    ...
    (_thisHandle) => GCRef.using(
      ...
      (_rangeHandle) => consumeCreatedRef<AttributedSubstring>(
        check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedSubstring_substringForRange(
            Loader.shared.env,
            _thisHandle.ptr,
            _rangeHandle.ptr,
            _exn,
  ...
  static AttributedSubstring createEmpty() => consumeCreatedRef<AttributedSubstring>(
    check((OutCreatedRef _exn) => f__iota_Foundation_AttributedSubstring_createEmpty(Loader.shared.env, _exn)),
  );
  ...
  bool operator ==(
    ...
    (thisHandle) => GCRef.using(
      other as AttributedSubstring,
      (otherHandle) => check(
        (exn) => f__iota_Foundation_AttributedSubstring_equals(Loader.shared.env, thisHandle.ptr, otherHandle.ptr, exn),
      ),
    ),
  );
  ...
  static late CreatedRef Function(Env env, OutCreatedRef _exn) f__iota_Foundation_AttributedSubstring_createEmpty;

...
class AttributedString extends SwiftReference {
  ...
  static CreatedRef ffi_new(ffi.Pointer ref, OutCreatedRef exn) => check((exn) => createRef(AttributedString(ref)));
  ...
  String get string => GCRef.using(
    this,
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<String>(
        f__iota_get_Foundation_AttributedString_string(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_Runs get runs => GCRef.using(
    this,
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_Runs>(
        f__iota_get_Foundation_AttributedString_runs(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_CharacterView get characters => GCRef.using(
    this,
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_CharacterView>(
        f__iota_get_Foundation_AttributedString_characters(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_UnicodeScalarView get unicodeScalars => GCRef.using(
    this,
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_UnicodeScalarView>(
        f__iota_get_Foundation_AttributedString_unicodeScalars(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedSubstring get substring => GCRef.using(
    this,
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedSubstring>(
        f__iota_get_Foundation_AttributedString_substring(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_Index get startIndex => GCRef.using(
    this,
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_Index>(
        f__iota_get_Foundation_AttributedString_startIndex(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  ...
  AttributedString_Index get endIndex => GCRef.using(
    this,
    (_thisHandle) => check(
      (exn) => consumeCreatedRef<AttributedString_Index>(
        f__iota_get_Foundation_AttributedString_endIndex(Loader.shared.env, _thisHandle.ptr, exn),
      ),
    ),
  );
  @override
  int get hashCode => GCRef.using(
    this,
    (_thisHandle) =>
        check((exn) => f__iota_get_Foundation_AttributedString_hash(Loader.shared.env, _thisHandle.ptr, exn)),
  );
  ...
  AttributedSubstring substringForRange(
    ...
    (_thisHandle) => GCRef.using(
      range,
      (_rangeHandle) => consumeCreatedRef<AttributedSubstring>(
        check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_substringForRange(
            Loader.shared.env,
            _thisHandle.ptr,
            _rangeHandle.ptr,
            _exn,
  ...
  void append(
    ...
    (_thisHandle) => GCRef.using(
      attributedString,
      (_attributedStringHandle) => check(
        (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_append(
          Loader.shared.env,
          _thisHandle.ptr,
          _attributedStringHandle.ptr,
          _exn,
        ),
      ),
    ),
  ...
  void appendSubstring(
    ...
    (_thisHandle) => GCRef.using(
      substring,
      (_substringHandle) => check(
        (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_appendSubstring(
          Loader.shared.env,
          _thisHandle.ptr,
          _substringHandle.ptr,
          _exn,
        ),
      ),
    ),
  ...
  void insert(
    ...
    (_thisHandle) => GCRef.using(
      attributedString,
      (_attributedStringHandle) => GCRef.using(
        index,
        (_indexHandle) => check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_insert(
            Loader.shared.env,
            _thisHandle.ptr,
            _attributedStringHandle.ptr,
            _indexHandle.ptr,
  ...
  void insertSubstring(
    ...
    (_thisHandle) => GCRef.using(
      substring,
      (_substringHandle) => GCRef.using(
        index,
        (_indexHandle) => check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_insertSubstring(
            Loader.shared.env,
            _thisHandle.ptr,
            _substringHandle.ptr,
            _indexHandle.ptr,
  ...
  void replaceSubrange(
    ...
    (_thisHandle) => GCRef.using(
      range,
      (_rangeHandle) => GCRef.using(
        attributedString,
        (_attributedStringHandle) => check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_replaceSubrange(
            Loader.shared.env,
            _thisHandle.ptr,
            _rangeHandle.ptr,
            _attributedStringHandle.ptr,
  ...
  void replaceSubrangeWithSubstring(
    ...
    (_thisHandle) => GCRef.using(
      ...
      (_rangeHandle) => GCRef.using(
        substring,
        (_substringHandle) => check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_replaceSubrangeWithSubstring(
            Loader.shared.env,
            _thisHandle.ptr,
            _rangeHandle.ptr,
            _substringHandle.ptr,
  ...
  void removeSubrange(
    ...
    (_thisHandle) => GCRef.using(
      range,
      (_rangeHandle) => check(
        (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_removeSubrange(
          Loader.shared.env,
          _thisHandle.ptr,
          _rangeHandle.ptr,
          _exn,
  ...
  void setAttributes(
    ...
    (_thisHandle) => GCRef.using(
      attributes,
      (_attributesHandle) => check(
        (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_setAttributes(
          Loader.shared.env,
          _thisHandle.ptr,
          _attributesHandle.ptr,
          _exn,
        ),
      ),
    ),
  ...
  void setAttributesForRange(
    ...
    (_thisHandle) => GCRef.using(
      ...
      (_rangeHandle) => GCRef.using(
        attributes,
        (_attributesHandle) => check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_setAttributesForRange(
            Loader.shared.env,
            _thisHandle.ptr,
            _rangeHandle.ptr,
            _attributesHandle.ptr,
  ...
  void mergeAttributes(
    ...
    (_thisHandle) => GCRef.using(
      attributes,
      (_attributesHandle) => check(
        (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_mergeAttributes(
          Loader.shared.env,
          _thisHandle.ptr,
          _attributesHandle.ptr,
          keepCurrent,
  ...
  void mergeAttributesForRange(
    ...
    (_thisHandle) => GCRef.using(
      ...
      (_rangeHandle) => GCRef.using(
        attributes,
        (_attributesHandle) => check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_mergeAttributesForRange(
            Loader.shared.env,
            _thisHandle.ptr,
            _rangeHandle.ptr,
            _attributesHandle.ptr,
  ...
  void replaceAttributes(
    ...
    (_thisHandle) => GCRef.using(
      attributes,
      (_attributesHandle) => GCRef.using(
        others,
        (_othersHandle) => check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_replaceAttributes(
            Loader.shared.env,
            _thisHandle.ptr,
            _attributesHandle.ptr,
            _othersHandle.ptr,
    ...
    (_thisHandle) => GCRef.using(
      ...
      (_rangeHandle) => GCRef.using(
        ...
        (_attributesHandle) => GCRef.using(
          others,
          (_othersHandle) => check(
            (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_replaceAttributesForRange(
              Loader.shared.env,
              _thisHandle.ptr,
              _rangeHandle.ptr,
              _attributesHandle.ptr,
  ...
  static AttributedString createEmpty() => consumeCreatedRef<AttributedString>(
    check((OutCreatedRef _exn) => f__iota_Foundation_AttributedString_createEmpty(Loader.shared.env, _exn)),
  );
  ...
  static AttributedString create(
    ...
    string,
    (_stringHandle) => GCRef.using(
      attributes,
      (_attributesHandle) => consumeCreatedRef<AttributedString>(
        check(
          (OutCreatedRef _exn) => f__iota_Foundation_AttributedString_create(
            Loader.shared.env,
            _stringHandle.ptr,
            _attributesHandle.ptr,
            _exn,
  ...
  static AttributedString createFromSubstring(
    ...
    substring,
    (_substringHandle) => consumeCreatedRef<AttributedString>(
      check(
        (OutCreatedRef _exn) =>
            f__iota_Foundation_AttributedString_createFromSubstring(Loader.shared.env, _substringHandle.ptr, _exn),
      ),
    ),
  );
  ...
  bool operator ==(
    ...
    (thisHandle) => GCRef.using(
      other as AttributedString,
      (otherHandle) => check(
        (exn) => f__iota_Foundation_AttributedString_equals(Loader.shared.env, thisHandle.ptr, otherHandle.ptr, exn),
      ),
    ),
  );
  ...
  static late void Function(Env env, UnownedRef _this, UnownedRef attributedString, OutCreatedRef _exn)
  f__iota_Foundation_AttributedString_append;
  static late void Function(Env env, UnownedRef _this, UnownedRef substring, OutCreatedRef _exn)
  f__iota_Foundation_AttributedString_appendSubstring;
  static late CreatedRef Function(Env env, UnownedRef string, UnownedRef attributes, OutCreatedRef _exn)
  f__iota_Foundation_AttributedString_create;
  static late CreatedRef Function(Env env, OutCreatedRef _exn) f__iota_Foundation_AttributedString_createEmpty;
  static late CreatedRef Function(Env env, UnownedRef substring, OutCreatedRef _exn)
  ...
  static late void Function(Env env, UnownedRef _this, UnownedRef substring, UnownedRef index, OutCreatedRef _exn)
  f__iota_Foundation_AttributedString_insertSubstring;
  static late void Function(Env env, UnownedRef _this, UnownedRef attributes, bool keepCurrent, OutCreatedRef _exn)
  ...
  static late void Function(Env env, UnownedRef _this, UnownedRef range, OutCreatedRef _exn)
  f__iota_Foundation_AttributedString_removeSubrange;
  static late void Function(Env env, UnownedRef _this, UnownedRef attributes, UnownedRef others, OutCreatedRef _exn)
  ...
  static late void Function(Env env, UnownedRef _this, UnownedRef range, UnownedRef substring, OutCreatedRef _exn)
  f__iota_Foundation_AttributedString_replaceSubrangeWithSubstring;
  static late void Function(Env env, UnownedRef _this, UnownedRef attributes, OutCreatedRef _exn)
  f__iota_Foundation_AttributedString_setAttributes;
  static late void Function(Env env, UnownedRef _this, UnownedRef range, UnownedRef attributes, OutCreatedRef _exn)
  f__iota_Foundation_AttributedString_setAttributesForRange;
  static late CreatedRef Function(Env env, UnownedRef _this, UnownedRef range, OutCreatedRef _exn)
  f__iota_Foundation_AttributedString_substringForRange;
  static late CreatedRef Function(Env env, UnownedRef _this, OutCreatedRef _exn)
  f__iota_get_Foundation_AttributedString_characters;
  static late CreatedRef Function(Env env, UnownedRef _this, OutCreatedRef _exn)
  f__iota_get_Foundation_AttributedString_endIndex;
  static late int Function(Env env, UnownedRef _this, OutCreatedRef _exn) f__iota_get_Foundation_AttributedString_hash;
  static late CreatedRef Function(Env env, UnownedRef _this, OutCreatedRef _exn)

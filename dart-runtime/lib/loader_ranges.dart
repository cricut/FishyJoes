...
typedef _RangeConstructor = CreatedRef Function(
  UnownedRef context, UnownedRef lowerBound, UnownedRef upperBound, OutCreatedRef exn
);

typedef _FishyJoesCommonRuntime_RangeConverter_setup<R> = R Function(
  Env env,
...
class _RangeConversions {
  ...
  static final ffi.Pointer<ffi.NativeFunction<_RangeConstructor>> constructorPtr = ffi.Pointer.fromFunction(_constructor);
...
extension LoaderRange on Loader {
  static final _fishyJoesCommonRuntime_RangeConverter_setup = Loader._dylib
      .lookupFunction<_FishyJoesCommonRuntime_RangeConverter_setup<ffi.Void>,

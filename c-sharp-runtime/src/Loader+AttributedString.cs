...
namespace Cricut.FishyJoesRuntime {
    public partial class Loader {
        ...
        static extern void FishyJoesCommonRuntime_AttributeContainer_setup(
            IntPtr envRef,
        ...
        [DllImport("FishyJoesIotaRuntime", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        static extern void FishyJoesCommonRuntime_AttributeContainer_FoundationAttributes_setup(
            IntPtr envRef,
            SwiftReference.ConstructorDelegate constructorMethod,
            out CreatedRef _exn
        );
        ...
        private static void setupAttributedString() {
            Once("setup_AttributeContainer", () => {
                ...
                Utilities.Check((out CreatedRef exn) => FishyJoesCommonRuntime_AttributeContainer_setup(
                    env,
            ...
            Once("setup_AttributeContainer.FoundationAttributes", () => {
                ...
                Utilities.Check((out CreatedRef exn) => FishyJoesCommonRuntime_AttributeContainer_FoundationAttributes_setup(
                    env,
                    bag<SwiftReference.ConstructorDelegate>((ConsumedRef ptr, out CreatedRef exn) => Catching(out exn, () => {

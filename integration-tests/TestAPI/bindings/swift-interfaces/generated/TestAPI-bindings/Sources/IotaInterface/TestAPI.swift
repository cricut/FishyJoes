...
// Generated by FishyJoes for the default value of `minValue` in `TestAPI.DefaultArguments.echoDefaultIntLimits(minValue: Int = .min, maxValue: Int = .max)`
@_cdecl("__iota_TestAPI_DefaultArguments_echoDefaultIntLimits_default_minValue")
public func __iota_TestAPI_DefaultArguments_echoDefaultIntLimits_default_minValue(
    envRef: EnvRef,
    _exn: foreignOutExn
) -> Swift.Int.CType {
    let env = Env(envRef)
    return env.catching(to: _exn) {
        let _defaultValue: Swift.Int = .min
        return try Swift.Int.toIota(_defaultValue, env: env)
    }
}

// Generated by FishyJoes for the default value of `maxValue` in `TestAPI.DefaultArguments.echoDefaultIntLimits(minValue: Int = .min, maxValue: Int = .max)`
@_cdecl("__iota_TestAPI_DefaultArguments_echoDefaultIntLimits_default_maxValue")
public func __iota_TestAPI_DefaultArguments_echoDefaultIntLimits_default_maxValue(
    envRef: EnvRef,
    _exn: foreignOutExn
) -> Swift.Int.CType {
    let env = Env(envRef)
    return env.catching(to: _exn) {
        let _defaultValue: Swift.Int = .max
        return try Swift.Int.toIota(_defaultValue, env: env)
    }
}
...
@_cdecl("__iota_TestAPI_DefaultArguments_echoExplicitIntMax")
public func __iota_TestAPI_DefaultArguments_echoExplicitIntMax(
    envRef: EnvRef,
...
// Generated by FishyJoes for the default value of `value` in `TestAPI.DefaultArguments.echoExplicitIntMax(value: Int = Int.max)`
@_cdecl("__iota_TestAPI_DefaultArguments_echoExplicitIntMax_default_value")
public func __iota_TestAPI_DefaultArguments_echoExplicitIntMax_default_value(
    envRef: EnvRef,
    _exn: foreignOutExn
) -> Swift.Int.CType {
    let env = Env(envRef)
    return env.catching(to: _exn) {
        let _defaultValue: Swift.Int = Int.max
        return try Swift.Int.toIota(_defaultValue, env: env)
    }
}

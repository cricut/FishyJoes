...
public func TestAPI_AssociatedDataEnum_setup(
    ...
    none_constructor: @escaping TestAPI.AssociatedDataEnum.None_constructor,
    none_extractor: @escaping TestAPI.AssociatedDataEnum.None_extractor,
    ...
    TestAPI.AssociatedDataEnum.none_constructor[env] = none_constructor
    TestAPI.AssociatedDataEnum.none_extractor[env] = none_extractor
...
extension TestAPI.AssociatedDataEnum: FishyJoesIotaRuntime.IotaConverter {
    ...
    public static func peekIota(_ value: HostObject, env: Env) throws -> Self {
        ...
        case 3:
            ...
            return Self.noValue
        case 4:
            try env.check { exn in none_extractor[env](value, exn) }
            return Self.none
        case 5:
...
@_cdecl("__iota_TestAPI_AsyncFunctions_delayedConst")
...
@_cdecl("__iota_TestAPI_DefaultArguments_describeEnumDefault")
public func __iota_TestAPI_DefaultArguments_describeEnumDefault(
    envRef: EnvRef,
    ...
    return env.catching(to: _exn) {
        return try Swift.String.toIota(
            TestAPI.DefaultArguments.describeEnumDefault(
                try Swift.Int.peekIota(value, env: env),
                color: try TestAPI.SimpleEnum.peekIota(color, env: env)
            ),
            env: env
        )
    }
...
@_cdecl("__iota_TestAPI_DefaultArguments_echoDefaultIntLimits")
public func __iota_TestAPI_DefaultArguments_echoDefaultIntLimits(
    envRef: EnvRef,
    ...
    return env.catching(to: _exn) {
        return try Swift.String.toIota(
            TestAPI.DefaultArguments.echoDefaultIntLimits(
                minValue: try Swift.Int.peekIota(minValue, env: env),
                maxValue: try Swift.Int.peekIota(maxValue, env: env)
            ),
            env: env
        )
    }
...
@_cdecl("__iota_TestAPI_DefaultArguments_echoDefaultTolerance")
    ...
    return env.catching(to: _exn) {
        return try Swift.Double.toIota(
            TestAPI.DefaultArguments.echoDefaultTolerance(
                try Swift.Double.peekIota(tolerance, env: env)
            ),
            env: env
        )
    }
...
public func __iota_get_TestAPI_EmptyEnum_aStaticProperty(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try Swift.Int.toIota(TestAPI.EmptyEnum.aStaticProperty, env: env)
    }
}
...
@_cdecl("__iota_TestAPI_Methods_methodWithNewlinesInTypes")
    ...
    return env.catching(to: _exn) {
        return try FishyJoesCommonRuntime.VoidConverter.toIota(
            TestAPI.Methods.methodWithNewlinesInTypes(
                thing: try AsyncFunction3Converter<Swift.Int, Foundation.Data, Swift.Bool, ResultConverter<Swift.Int, TestAPI.Methods.TheMethodError>>.peekIota(thing, env: env)
            ),
            env: env
        )
    }
...
// MARK: - IotaInterface/TestAPI.Methods.TheMethodError+iota-type.swift
...
public func TestAPI_Methods_TheMethodError_setup(
    ...
    TestAPI.Methods.TheMethodError._constructorMethod[env] = constructorMethod
}
...
// MARK: - IotaInterface/TestAPI.ProtocolFixtures+iota-methods.swift

// Generated by FishyJoes for `TestAPI.ProtocolFixtures.describeAProtocol(_ value: AProtocol, x: Int, y: Int)`
@_cdecl("__iota_TestAPI_ProtocolFixtures_describeAProtocol")
public func __iota_TestAPI_ProtocolFixtures_describeAProtocol(
    envRef: EnvRef,
    ...
    return env.catching(to: _exn) {
        return try Swift.String.toIota(
            TestAPI.ProtocolFixtures.describeAProtocol(
                try TestAPI_CommonInterface._AProtocolConverter.peekIota(value, env: env),
                x: try Swift.Int.peekIota(x, env: env),
                y: try Swift.Int.peekIota(y, env: env)
            ),
            env: env
...
@_cdecl("__iota_TestAPI_ProtocolFixtures_returnAProtocol")
...
// MARK: - IotaInterface/TestAPI.ProtocolFixtures+iota-type.swift

@_cdecl("TestAPI_ProtocolFixtures_setup")
public func TestAPI_ProtocolFixtures_setup(
    envRef: EnvRef
) {
}
...
// MARK: - IotaInterface/TestAPI.PythonNamingCollisions+iota-methods.swift
...
public func __iota_get_TestAPI_PythonNamingCollisions_class(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try Swift.Int.toIota(TestAPI.PythonNamingCollisions.classValue, env: env)
    }
}
...
public func __iota_get_TestAPI_PythonNamingCollisions___dunder__(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try Swift.Int.toIota(TestAPI.PythonNamingCollisions.dunderValue, env: env)
    }
}
...
public func __iota_get_TestAPI_PythonNamingCollisions_isNaN(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try Swift.Bool.toIota(TestAPI.PythonNamingCollisions.isNaNValue, env: env)
    }
}
...
@_cdecl("__iota_TestAPI_PythonNamingCollisions_keywordArgs")
public func __iota_TestAPI_PythonNamingCollisions_keywordArgs(
    envRef: EnvRef,
    ...
    return env.catching(to: _exn) {
        return try Swift.Int.toIota(
            TestAPI.PythonNamingCollisions.keywordArgs(
                `class`: try Swift.Int.peekIota(`class`, env: env),
                list: try Swift.Int.peekIota(list, env: env)
            ),
            env: env
        )
    }
...
public func __iota_get_TestAPI_PythonNamingCollisions__leadingUnderscore(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try Swift.Int.toIota(TestAPI.PythonNamingCollisions.leadingUnderscoreValue, env: env)
    }
}
...
public func __iota_get_TestAPI_PythonNamingCollisions_list(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try Swift.Int.toIota(TestAPI.PythonNamingCollisions.listValue, env: env)
    }
}
...
public func __iota_get_TestAPI_PythonNamingCollisions_Url(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try Swift.String.toIota(TestAPI.PythonNamingCollisions.titleUrl, env: env)
    }
}
...
public func __iota_get_TestAPI_PythonNamingCollisions_URL(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try Swift.String.toIota(TestAPI.PythonNamingCollisions.upperURL, env: env)
    }
}

// MARK: - IotaInterface/TestAPI.PythonNamingCollisions+iota-type.swift

@_cdecl("TestAPI_PythonNamingCollisions_setup")
public func TestAPI_PythonNamingCollisions_setup(
    envRef: EnvRef
) {
}
...
// MARK: - IotaInterface/TestAPI.ReferenceCaseEnum+iota-methods.swift
...
public func __iota_get_TestAPI_ReferenceCaseEnum_defaultDirection(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try TestAPI.ReferenceCaseEnum.toIota(TestAPI.ReferenceCaseEnum.defaultDirection, env: env)
    }
}
...
public func __iota_get_TestAPI_ReferenceCaseEnum_opposite(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try TestAPI.ReferenceCaseEnum.toIota(TestAPI.ReferenceCaseEnum.peekIota(_iotaThis, env: env).opposite, env: env)
    }
}
...
@_cdecl("__iota_TestAPI_ReferenceCaseEnum_rotate180")
public func __iota_TestAPI_ReferenceCaseEnum_rotate180(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        return try TestAPI.ReferenceCaseEnum.toIota(
            TestAPI.ReferenceCaseEnum.rotate180(
                try TestAPI.ReferenceCaseEnum.peekIota(direction, env: env)
            ),
            env: env
        )
    }
...
// MARK: - IotaInterface/TestAPI.ReferenceCaseEnum+iota-type.swift

@_cdecl("TestAPI_ReferenceCaseEnum_setup")
public func TestAPI_ReferenceCaseEnum_setup(
    envRef: EnvRef,
    discriminator: @escaping TestAPI.ReferenceCaseEnum.Discriminator,
    north_constructor: @escaping TestAPI.ReferenceCaseEnum.North_constructor,
    north_extractor: @escaping TestAPI.ReferenceCaseEnum.North_extractor,
    south_constructor: @escaping TestAPI.ReferenceCaseEnum.South_constructor,
    south_extractor: @escaping TestAPI.ReferenceCaseEnum.South_extractor,
    east_constructor: @escaping TestAPI.ReferenceCaseEnum.East_constructor,
    east_extractor: @escaping TestAPI.ReferenceCaseEnum.East_extractor,
    west_constructor: @escaping TestAPI.ReferenceCaseEnum.West_constructor,
    west_extractor: @escaping TestAPI.ReferenceCaseEnum.West_extractor
) {
    let env = Env(envRef)
    TestAPI.ReferenceCaseEnum.discriminator[env] = discriminator
    TestAPI.ReferenceCaseEnum.north_constructor[env] = north_constructor
    TestAPI.ReferenceCaseEnum.north_extractor[env] = north_extractor
    TestAPI.ReferenceCaseEnum.south_constructor[env] = south_constructor
    TestAPI.ReferenceCaseEnum.south_extractor[env] = south_extractor
    TestAPI.ReferenceCaseEnum.east_constructor[env] = east_constructor
    TestAPI.ReferenceCaseEnum.east_extractor[env] = east_extractor
    TestAPI.ReferenceCaseEnum.west_constructor[env] = west_constructor
    TestAPI.ReferenceCaseEnum.west_extractor[env] = west_extractor
}
...
extension TestAPI.ReferenceCaseEnum: FishyJoesIotaRuntime.IotaConverter {
    ...
    public static func peekIota(_ value: HostObject, env: Env) throws -> Self {
        ...
        case 0:
            ...
            return Self.north
        case 1:
            try env.check { exn in south_extractor[env](value, exn) }
            return Self.south
        case 2:
            try env.check { exn in east_extractor[env](value, exn) }
            return Self.east
        case 3:
            try env.check { exn in west_extractor[env](value, exn) }
            return Self.west
        case let disc:
            fatalError("bad discriminator value \(disc) encountered for type \(self)")
        }
    ...
    public static func toIota(_ value: Self, env: Env) throws -> HostObject {
        ...
        case north:
            return try env.check { exn in
                return north_constructor[env](
                    exn
                )
            }
        case south:
            return try env.check { exn in
                return south_constructor[env](
                    exn
                )
            }
        case east:
            return try env.check { exn in
                return east_constructor[env](
                    exn
                )
            }
        case west:
            return try env.check { exn in
                return west_constructor[env](
                    exn
                )
            }
        }
...
// MARK: - IotaInterface/TestAPI.ReferenceEmptyEnum+iota-methods.swift
...
public func __iota_get_TestAPI_ReferenceEmptyEnum_aStaticProperty(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try Swift.Int.toIota(TestAPI.ReferenceEmptyEnum.aStaticProperty, env: env)
    }
}
...
// MARK: - IotaInterface/TestAPI.ReferenceEmptyEnum+iota-type.swift

@_cdecl("TestAPI_ReferenceEmptyEnum_setup")
public func TestAPI_ReferenceEmptyEnum_setup(
    envRef: EnvRef
) {
}
...
// MARK: - IotaInterface/TestAPI.ReferenceOnlyTypes+iota-methods.swift
...
public func __iota_TestAPI_ReferenceOnlyTypes_marker(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        return try TestAPI.ReferenceOnlyTypes.Marker.toIota(
...
// MARK: - IotaInterface/TestAPI.ReferenceOnlyTypes+iota-type.swift

@_cdecl("TestAPI_ReferenceOnlyTypes_setup")
public func TestAPI_ReferenceOnlyTypes_setup(
    envRef: EnvRef
) {
}
...
// MARK: - IotaInterface/TestAPI.ReferenceOnlyTypes.Marker+iota-type.swift
...
public func TestAPI_ReferenceOnlyTypes_Marker_setup(
    ...
    TestAPI.ReferenceOnlyTypes.Marker._constructorMethod[env] = constructorMethod
}
...
public func TestAPI_ReferenceOnlyTypes_Marker_iotaEquals(envRef: EnvRef, lhs: HostObject, rhs: HostObject, exn: OutHostException) -> Bool.CType {
    ...
    return env.catching(to: exn) {
        try Bool.toIota(
            TestAPI.ReferenceOnlyTypes.Marker.peekIota(lhs, env: env) == TestAPI.ReferenceOnlyTypes.Marker.peekIota(rhs, env: env),
            env: env
        )
    }
}
...
public func TestAPI_ReferenceOnlyTypes_Marker_iotaHash(envRef: EnvRef, this: HostObject, exn: OutHostException) -> Int32.CType {
    ...
    return env.catching(to: exn) {
        try Int32.toIota(
            Int32(truncatingIfNeeded: TestAPI.ReferenceOnlyTypes.Marker.peekIota(this, env: env).hashValue),
            env: env
        )
    }
}
...
// MARK: - IotaInterface/TestAPI.Shade+iota-type.swift

@_cdecl("TestAPI_Shade_setup")
public func TestAPI_Shade_setup(
    ...
    TestAPI.Shade._constructorMethod[env] = constructorMethod
    TestAPI.Shade._darknessGetter[env] = darknessGetter
    TestAPI.Shade._darknessSetter[env] = darknessSetter
}
...
// MARK: - IotaInterface/TestAPI.ShadowBox+iota-methods.swift
...
public func __iota_get_TestAPI_ShadowBox_allShades(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try ArrayConverter<TestAPI.Shade>.toIota(TestAPI.ShadowBox.peekIota(_iotaThis, env: env).allShades, env: env)
    }
}
...
@_cdecl("__iota_TestAPI_ShadowBox_darkest")
public func __iota_TestAPI_ShadowBox_darkest(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        return try OptionalConverter<TestAPI.Shade>.toIota(
            TestAPI.ShadowBox.darkest(
                of: try ArrayConverter<TestAPI.Shade>.peekIota(shades, env: env)
            ),
            env: env
        )
    }
...
// MARK: - IotaInterface/TestAPI.ShadowBox+iota-type.swift

@_cdecl("TestAPI_ShadowBox_setup")
public func TestAPI_ShadowBox_setup(
    envRef: EnvRef,
    discriminator: @escaping TestAPI.ShadowBox.Discriminator,
    shade_constructor: @escaping TestAPI.ShadowBox.Shade_constructor,
    shade_extractor: @escaping TestAPI.ShadowBox.Shade_extractor,
    empty_constructor: @escaping TestAPI.ShadowBox.Empty_constructor,
    empty_extractor: @escaping TestAPI.ShadowBox.Empty_extractor
) {
    let env = Env(envRef)
    TestAPI.ShadowBox.discriminator[env] = discriminator
    TestAPI.ShadowBox.shade_constructor[env] = shade_constructor
    TestAPI.ShadowBox.shade_extractor[env] = shade_extractor
    TestAPI.ShadowBox.empty_constructor[env] = empty_constructor
    TestAPI.ShadowBox.empty_extractor[env] = empty_extractor
}
...
extension TestAPI.ShadowBox: FishyJoesIotaRuntime.IotaConverter {
    ...
    public static func peekIota(_ value: HostObject, env: Env) throws -> Self {
        ...
        case 0:
            ...
            try env.check { exn in shade_extractor[env](value, &__0, exn) }
            defer {
                env.deleteRef(__0)
            }
            return Self.shade(
                try TestAPI.Shade.peekIota(__0, env: env)
            )
        case 1:
            try env.check { exn in empty_extractor[env](value, exn) }
            return Self.empty
        case let disc:
            fatalError("bad discriminator value \(disc) encountered for type \(self)")
        }
    ...
    public static func toIota(_ value: Self, env: Env) throws -> HostObject {
        ...
        case let shade(_0):
            return try env.check { exn in
                return shade_constructor[env](
                    try TestAPI.Shade.toIota(_0, env: env),
                    exn
                )
            }
        case empty:
            return try env.check { exn in
                return empty_constructor[env](
                    exn
                )
            }
        }
...
public func __iota_get_TestAPI_URLs_dataImage(
    ...
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try Foundation.URL.toIota(TestAPI.URLs.dataImage, env: env)
    }
}

...
@_cdecl("__iota_get_TestAPI_TestDefaultComputedProperties_noot")
public func __iota_get_TestAPI_TestDefaultComputedProperties_noot(
    envRef: EnvRef,
    _iotaThis: foreignObject,
    _exn: foreignOutExn
) -> Swift.Int.CType {
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try Swift.Int.toIota(TestAPI_CommonInterface._TestDefaultComputedPropertiesConverter.peekIota(_iotaThis, env: env).noot, env: env)
    }
}
...
@_cdecl("__iota_get_TestAPI_TestDefaultComputedProperties_plutonic")
public func __iota_get_TestAPI_TestDefaultComputedProperties_plutonic(
    envRef: EnvRef,
    _iotaThis: foreignObject,
    _exn: foreignOutExn
) -> Swift.String.CType {
    let env = Env(envRef)
    return env.catching(to: _exn) {
        try Swift.String.toIota(TestAPI_CommonInterface._TestDefaultComputedPropertiesConverter.peekIota(_iotaThis, env: env).pluto, env: env)
    }
}

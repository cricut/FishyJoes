...
public func registerModuleTestAPI(env: NAPI.Env, exports: NAPI.Value) throws -> NAPI.Value {
    ...
    try ResultConverter<Swift.Int, TestAPI.Results.Error>.nodeSetup(env: env, module: module)
    try ResultConverter<Swift.String, TestAPI.Results.Error>.nodeSetup(env: env, module: module)

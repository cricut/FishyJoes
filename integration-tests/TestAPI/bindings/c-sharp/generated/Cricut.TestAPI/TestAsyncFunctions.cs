...
namespace Cricut.TestAPI {
    ...
    public interface TestAsyncFunctions {
        ...
        /// </summary>
        publicSystem.Func<float, double, nint, System.Threading.Tasks.Task<double>> GetAdd3Things() {
        ...
        /// </summary>
        publicSystem.Func<System.Threading.Tasks.Task<nint>> GetConst42() {
            using var thisHandle = new GCRef(this);
            return Check((out CreatedRef exn) =>
                __iota_get_TestAPI_TestAsyncFunctions_const42(Loader.env, thisHandle.ptr, out exn).Consume<System.Func<System.Threading.Tasks.Task<nint>>>()
            );
        }
        ...
        /// </summary>
        publicSystem.Func<string, nint, double, string, System.Func<System.Threading.Tasks.Task<nint>>, System.Threading.Tasks.Task<System.Func<System.Threading.Tasks.Task<nint>>>> GetFifthThing() {
            using var thisHandle = new GCRef(this);
            return Check((out CreatedRef exn) =>
        ...
        /// </summary>
        publicSystem.Func<nint, System.Threading.Tasks.Task<nint>> GetIabs() {
            using var thisHandle = new GCRef(this);
            return Check((out CreatedRef exn) =>
                __iota_get_TestAPI_TestAsyncFunctions_iabs(Loader.env, thisHandle.ptr, out exn).Consume<System.Func<nint, System.Threading.Tasks.Task<nint>>>()
            );
        }

        [DllImport("TestAPI-iota", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        private static extern CreatedRef __iota_get_TestAPI_TestAsyncFunctions_iabs(IntPtr envRef, UnownedRef self, out CreatedRef exn);

        /// <summary>
        /// <!-- FishyJoes.export(intCompose) -->
        /// </summary>
        publicSystem.Func<System.Func<nint, System.Threading.Tasks.Task<nint>>, System.Func<nint, System.Threading.Tasks.Task<nint>>, System.Func<nint, System.Threading.Tasks.Task<nint>>> GetIntCompose() {
            using var thisHandle = new GCRef(this);
            return Check((out CreatedRef exn) =>
                __iota_get_TestAPI_TestAsyncFunctions_intCompose(Loader.env, thisHandle.ptr, out exn).Consume<System.Func<System.Func<nint, System.Threading.Tasks.Task<nint>>, System.Func<nint, System.Threading.Tasks.Task<nint>>, System.Func<nint, System.Threading.Tasks.Task<nint>>>>()
            );
        }
        ...
        /// </summary>
        publicSystem.Func<string, string, string, string, System.Threading.Tasks.Task<System.Collections.Generic.IList<string>>> GetMakeList() {
            using var thisHandle = new GCRef(this);
            return Check((out CreatedRef exn) =>
                __iota_get_TestAPI_TestAsyncFunctions_makeList(Loader.env, thisHandle.ptr, out exn).Consume<System.Func<string, string, string, string, System.Threading.Tasks.Task<System.Collections.Generic.IList<string>>>>()
            );
        }
        ...
        /// </summary>
        publicSystem.Func<string, nint, double, string, System.Func<System.Threading.Tasks.Task<nint>>, nint, System.Threading.Tasks.Task<nint>> GetSix() {
            using var thisHandle = new GCRef(this);
            return Check((out CreatedRef exn) =>
                __iota_get_TestAPI_TestAsyncFunctions_six(Loader.env, thisHandle.ptr, out exn).Consume<System.Func<string, nint, double, string, System.Func<System.Threading.Tasks.Task<nint>>, nint, System.Threading.Tasks.Task<nint>>>()
            );
        }

        [DllImport("TestAPI-iota", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        private static extern CreatedRef __iota_get_TestAPI_TestAsyncFunctions_six(IntPtr envRef, UnownedRef self, out CreatedRef exn);

        /// <summary>
        /// <!-- FishyJoes.export(willThrow) -->
        /// </summary>
        publicSystem.Func<System.Threading.Tasks.Task<nint>> GetWillThrow() {
            using var thisHandle = new GCRef(this);
            return Check((out CreatedRef exn) =>
                __iota_get_TestAPI_TestAsyncFunctions_willThrow(Loader.env, thisHandle.ptr, out exn).Consume<System.Func<System.Threading.Tasks.Task<nint>>>()
            );
        }

        [DllImport("TestAPI-iota", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        private static extern CreatedRef __iota_get_TestAPI_TestAsyncFunctions_willThrow(IntPtr envRef, UnownedRef self, out CreatedRef exn);

        /// <summary>
        /// <!-- FishyJoes.export(exercise0) -->
        /// </summary>
        publicSystem.Threading.Tasks.Task<string> Exercise0(
        ...
        /// </summary>
        publicSystem.Threading.Tasks.Task<string> Exercise1(
        ...
        /// </summary>
        publicSystem.Threading.Tasks.Task<string> Exercise2(
        ...
        /// </summary>
        publicSystem.Threading.Tasks.Task<string> Exercise3(
        ...
        /// </summary>
        publicSystem.Threading.Tasks.Task<string> Exercise4(
        ...
        /// </summary>
        publicSystem.Threading.Tasks.Task<string> Exercise5(
        ...
        /// </summary>
        publicSystem.Threading.Tasks.Task<string> Exercise6(
        ...
        /// </summary>
        publicSystem.Func<System.Threading.Tasks.Task> ThunkTwiceMaker(
        ...
        /// </summary>
        publicSystem.Threading.Tasks.Task<string> DefaultExercise6(
            System.Func<string, nint, double, string, System.Func<System.Threading.Tasks.Task<nint>>, nint, System.Threading.Tasks.Task<nint>> fn
        ) {
            using var _thisHandle = new GCRef(this);
            using var _fnHandle = new GCRef(fn);
        ...
        /// </summary>
        publicCricut.TestAPI.TestAsyncFunctions Witness(
        ) {
            using var _thisHandle = new GCRef(this);

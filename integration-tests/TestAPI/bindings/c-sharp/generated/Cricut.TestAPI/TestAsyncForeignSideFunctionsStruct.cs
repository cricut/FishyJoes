...
namespace Cricut.TestAPI {
    ...
    public record TestAsyncForeignSideFunctionsStruct: Cricut.TestAPI.TestAsyncFunctions {
        ...
        publicSystem.Threading.Tasks.Task<string> DefaultExercise6(
            ...
            using var _thisHandle = new GCRef(this);
            using var _fnHandle = new GCRef(fn);
            return Check((out CreatedRef _exn) => __iota_TestAPI_TestAsyncForeignSideFunctionsStruct_defaultExercise6(Loader.env, _thisHandle.ptr, _fnHandle.ptr, out _exn)).Consume<System.Threading.Tasks.Task<string>>();
        }

        [DllImport("TestAPI-iota", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        private static extern CreatedRef __iota_TestAPI_TestAsyncForeignSideFunctionsStruct_defaultExercise6(
            IntPtr envRef,
            UnownedRef self,
            UnownedRef fn,
            out CreatedRef exn

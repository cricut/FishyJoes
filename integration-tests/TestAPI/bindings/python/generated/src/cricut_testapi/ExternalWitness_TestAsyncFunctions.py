...
class ExternalWitness_TestAsyncFunctions(NativeReference):
    ...
    def add3Things(self) -> typing.Callable[[int, int, int], typing.Awaitable[int]]:
        ...
        return _get_runtime().invoke("__iota_get_TestAPI_TestAsyncFunctions_add3Things", "object", ("object", self))
    ...
    def const42(self) -> typing.Callable[[], typing.Awaitable[int]]:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().invoke("__iota_get_TestAPI_TestAsyncFunctions_const42", "object", ("object", self))
    ...
    def fifthThing(self) -> typing.Callable[[str, int, int, str, typing.Callable[[], typing.Awaitable[int]]], typing.Awaitable[typing.Callable[[], typing.Awaitable[int]]]]:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().invoke("__iota_get_TestAPI_TestAsyncFunctions_fifthThing", "object", ("object", self))
    ...
    def iabs(self) -> typing.Callable[[int], typing.Awaitable[int]]:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().invoke("__iota_get_TestAPI_TestAsyncFunctions_iabs", "object", ("object", self))
    ...
    def intCompose(self) -> typing.Callable[[typing.Callable[[int], typing.Awaitable[int]], typing.Callable[[int], typing.Awaitable[int]]], typing.Callable[[int], typing.Awaitable[int]]]:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().invoke("__iota_get_TestAPI_TestAsyncFunctions_intCompose", "object", ("object", self))
    ...
    def makeList(self) -> typing.Callable[[str, str, str, str], typing.Awaitable[list[str]]]:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().invoke("__iota_get_TestAPI_TestAsyncFunctions_makeList", "object", ("object", self))
    ...
    def six(self) -> typing.Callable[[str, int, int, str, typing.Callable[[], typing.Awaitable[int]], int], typing.Awaitable[int]]:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().invoke("__iota_get_TestAPI_TestAsyncFunctions_six", "object", ("object", self))
    ...
    def willThrow(self) -> typing.Callable[[], typing.Awaitable[int]]:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().invoke("__iota_get_TestAPI_TestAsyncFunctions_willThrow", "object", ("object", self))
    ...
    def thunkTwiceMaker(self, thunk: typing.Callable[[], typing.Awaitable[None]]) -> typing.Callable[[], typing.Awaitable[None]]:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().invoke("__iota_TestAPI_TestAsyncFunctions_thunkTwiceMaker", "object", ("object", self), ("object", thunk))
    ...
    def witness(self) -> TestAsyncFunctions:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().invoke("__iota_TestAPI_TestAsyncFunctions_witness", "object", ("object", self))

...
class EmptyEnum:
    ...
    def aStaticProperty() -> builtins.int:
        ...
        return _get_runtime().call_symbol("__iota_get_TestAPI_EmptyEnum_aStaticProperty", "int")
    ...
    def notGoingToHappen() -> EmptyEnum:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().call_symbol("__iota_TestAPI_EmptyEnum_notGoingToHappen", "object")
    ...
    def aStaticMethod() -> builtins.int:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().call_symbol("__iota_TestAPI_EmptyEnum_aStaticMethod", "int")

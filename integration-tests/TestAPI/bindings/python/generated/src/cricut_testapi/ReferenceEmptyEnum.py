...
class ReferenceEmptyEnum:
    ...
    def aStaticProperty() -> int:
        ...
        return _get_runtime().invoke("__iota_get_TestAPI_ReferenceEmptyEnum_aStaticProperty", "object")
    ...
    def aStaticMethod() -> int:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().invoke("__iota_TestAPI_ReferenceEmptyEnum_aStaticMethod", "object")

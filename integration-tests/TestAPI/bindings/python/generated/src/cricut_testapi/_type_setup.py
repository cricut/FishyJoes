...
def ensure_loaded() -> None:
    ...
    _runtime.setup_protocol_type("TestAPI_CommonInterface__TestDefaultComputedPropertiesConverter_setup", ExternalWitness_TestDefaultComputedProperties, [("noot", "object"), ("pluto", "object")], [])
    ...
    _runtime.setup_protocol_type("TestAPI_CommonInterface__TestDifferingExportNameProtocolConverter_setup", ExternalWitness_TestDifferingExportNameProtocolDiffy, [("tata", "object")], [])
    ...
    _runtime.setup_protocol_type("TestAPI_CommonInterface__TestMethodsProtocolConverter_setup", ExternalWitness_TestMethodsProtocol, [], [("foo", [], "void"), ("bar", [], "object"), ("baz", ["object"], "void"), ("garply", ["object"], "object"), ("xyzzy", ["object", "object"], "object"), ("plugh", ["object"], "object")])
    _runtime.setup_enum_type("TestAPI_TestNonExportedProtocolEnum_setup", TestNonExportedProtocolEnum, True, [("hogehoge", [])])
    _runtime.setup_protocol_type("TestAPI_CommonInterface__TestOptionalsProtocolConverter_setup", ExternalWitness_TestOptionalsProtocol, [("flarp", "object")], [("wombat", ["object"], "object"), ("spqr", ["object"], "object")])

...
class TestProtocolStruct:
    ...
    def bar(self) -> int:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().invoke("__iota_TestAPI_TestProtocolStruct_bar", "object", ("object", self))
    ...
    def baz(self, qux: int) -> None:
        ...
        """
        _ensure_runtime_loaded()
        _get_runtime().invoke("__iota_TestAPI_TestProtocolStruct_baz", "void", ("object", self), ("object", qux))
    ...
    def xyzzy(self, thud: int, grault: list[int]) -> str:
        ...
        """
        _ensure_runtime_loaded()
        return _get_runtime().invoke("__iota_TestAPI_TestProtocolStruct_xyzzy", "object", ("object", self), ("object", thud), ("object", grault))

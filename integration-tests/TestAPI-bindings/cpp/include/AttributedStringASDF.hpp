...
namespace TestAPI {
    ...
    class AttributedStringASDF {
        ...
        class AttributeMergePolicy {
            ...
            private:
            using VariantType = std::variant<keepNew, keepCurrent>;
            
            public:
            template <typename T>
            AttributeMergePolicy(const T& caseObj): _variant(caseObj) {}
            
            template <typename T>
            AttributeMergePolicy& operator=(const T& rhs) {
                _variant = rhs;
                return *this;
            }
            ...
            AttributeMergePolicy(const std::variant<keepNew,keepCurrent> &_variant);
            ...
            std::variant<keepNew,keepCurrent> _variant;

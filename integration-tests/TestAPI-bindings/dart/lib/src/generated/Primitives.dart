...
class Primitives {
    ...
    static bool get falseBool =>
        check((exn) =>
            f__dart_get_Primitives_falseBool(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(trueBool) -->
    static bool get trueBool =>
        check((exn) =>
            f__dart_get_Primitives_trueBool(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(zeroUInt8) -->
    static int get zeroUInt8 =>
        check((exn) =>
            f__dart_get_Primitives_zeroUInt8(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(minUInt8) -->
    static int get minUInt8 =>
        check((exn) =>
            f__dart_get_Primitives_minUInt8(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(maxUInt8) -->
    static int get maxUInt8 =>
        check((exn) =>
            f__dart_get_Primitives_maxUInt8(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(zeroUInt16) -->
    static int get zeroUInt16 =>
        check((exn) =>
            f__dart_get_Primitives_zeroUInt16(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(minUInt16) -->
    static int get minUInt16 =>
        check((exn) =>
            f__dart_get_Primitives_minUInt16(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(maxUInt16) -->
    static int get maxUInt16 =>
        check((exn) =>
            f__dart_get_Primitives_maxUInt16(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(zeroUInt32) -->
    static int get zeroUInt32 =>
        check((exn) =>
            f__dart_get_Primitives_zeroUInt32(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(minUInt32) -->
    static int get minUInt32 =>
        check((exn) =>
            f__dart_get_Primitives_minUInt32(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(maxUInt32) -->
    static int get maxUInt32 =>
        check((exn) =>
            f__dart_get_Primitives_maxUInt32(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(zeroUInt64) -->
    static int get zeroUInt64 =>
        check((exn) =>
            f__dart_get_Primitives_zeroUInt64(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(minUInt64) -->
    static int get minUInt64 =>
        check((exn) =>
            f__dart_get_Primitives_minUInt64(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(maxUInt64) -->
    static int get maxUInt64 =>
        check((exn) =>
            f__dart_get_Primitives_maxUInt64(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(zeroInt8) -->
    static int get zeroInt8 =>
        check((exn) =>
            f__dart_get_Primitives_zeroInt8(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(minInt8) -->
    static int get minInt8 =>
        check((exn) =>
            f__dart_get_Primitives_minInt8(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(maxInt8) -->
    static int get maxInt8 =>
        check((exn) =>
            f__dart_get_Primitives_maxInt8(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(zeroInt16) -->
    static int get zeroInt16 =>
        check((exn) =>
            f__dart_get_Primitives_zeroInt16(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(minInt16) -->
    static int get minInt16 =>
        check((exn) =>
            f__dart_get_Primitives_minInt16(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(maxInt16) -->
    static int get maxInt16 =>
        check((exn) =>
            f__dart_get_Primitives_maxInt16(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(zeroInt32) -->
    static int get zeroInt32 =>
        check((exn) =>
            f__dart_get_Primitives_zeroInt32(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(minInt32) -->
    static int get minInt32 =>
        check((exn) =>
            f__dart_get_Primitives_minInt32(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(maxInt32) -->
    static int get maxInt32 =>
        check((exn) =>
            f__dart_get_Primitives_maxInt32(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(zeroInt64) -->
    static int get zeroInt64 =>
        check((exn) =>
            f__dart_get_Primitives_zeroInt64(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(minInt64) -->
    static int get minInt64 =>
        check((exn) =>
            f__dart_get_Primitives_minInt64(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(maxInt64) -->
    static int get maxInt64 =>
        check((exn) =>
            f__dart_get_Primitives_maxInt64(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(zeroInt) -->
    static int get zeroInt =>
        check((exn) =>
            f__dart_get_Primitives_zeroInt(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(minInt) -->
    static int get minInt =>
        check((exn) =>
            f__dart_get_Primitives_minInt(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(maxInt) -->
    static int get maxInt =>
        check((exn) =>
            f__dart_get_Primitives_maxInt(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(zeroFloat) -->
    static double get zeroFloat =>
        check((exn) =>
            f__dart_get_Primitives_zeroFloat(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(minFloat) -->
    static double get minFloat =>
        check((exn) =>
            f__dart_get_Primitives_minFloat(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(maxFloat) -->
    static double get maxFloat =>
        check((exn) =>
            f__dart_get_Primitives_maxFloat(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(zeroDouble) -->
    static double get zeroDouble =>
        check((exn) =>
            f__dart_get_Primitives_zeroDouble(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(minDouble) -->
    static double get minDouble =>
        check((exn) =>
            f__dart_get_Primitives_minDouble(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(maxDouble) -->
    static double get maxDouble =>
        check((exn) =>
            f__dart_get_Primitives_maxDouble(Loader.shared.env, exn)
        )
    ;
    /// <!-- FishyJoes.export(manyBool) -->
    static List<bool> get manyBool =>
        check((exn) =>
            consumeCreatedRef<List<bool>>(f__dart_get_Primitives_manyBool(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyUInt8) -->
    static List<int> get manyUInt8 =>
        check((exn) =>
            consumeCreatedRef<List<int>>(f__dart_get_Primitives_manyUInt8(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyUInt16) -->
    static List<int> get manyUInt16 =>
        check((exn) =>
            consumeCreatedRef<List<int>>(f__dart_get_Primitives_manyUInt16(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyUInt32) -->
    static List<int> get manyUInt32 =>
        check((exn) =>
            consumeCreatedRef<List<int>>(f__dart_get_Primitives_manyUInt32(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyUInt64) -->
    static List<int> get manyUInt64 =>
        check((exn) =>
            consumeCreatedRef<List<int>>(f__dart_get_Primitives_manyUInt64(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyInt8) -->
    static List<int> get manyInt8 =>
        check((exn) =>
            consumeCreatedRef<List<int>>(f__dart_get_Primitives_manyInt8(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyInt16) -->
    static List<int> get manyInt16 =>
        check((exn) =>
            consumeCreatedRef<List<int>>(f__dart_get_Primitives_manyInt16(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyInt32) -->
    static List<int> get manyInt32 =>
        check((exn) =>
            consumeCreatedRef<List<int>>(f__dart_get_Primitives_manyInt32(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyInt64) -->
    static List<int> get manyInt64 =>
        check((exn) =>
            consumeCreatedRef<List<int>>(f__dart_get_Primitives_manyInt64(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyFloat) -->
    static List<double> get manyFloat =>
        check((exn) =>
            consumeCreatedRef<List<double>>(f__dart_get_Primitives_manyFloat(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyDouble) -->
    static List<double> get manyDouble =>
        check((exn) =>
            consumeCreatedRef<List<double>>(f__dart_get_Primitives_manyDouble(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyMaybeBool) -->
    static List<bool?> get manyMaybeBool =>
        check((exn) =>
            consumeCreatedRef<List<bool?>>(f__dart_get_Primitives_manyMaybeBool(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyMaybeUInt8) -->
    static List<int?> get manyMaybeUInt8 =>
        check((exn) =>
            consumeCreatedRef<List<int?>>(f__dart_get_Primitives_manyMaybeUInt8(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyMaybeUInt16) -->
    static List<int?> get manyMaybeUInt16 =>
        check((exn) =>
            consumeCreatedRef<List<int?>>(f__dart_get_Primitives_manyMaybeUInt16(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyMaybeUInt32) -->
    static List<int?> get manyMaybeUInt32 =>
        check((exn) =>
            consumeCreatedRef<List<int?>>(f__dart_get_Primitives_manyMaybeUInt32(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyMaybeUInt64) -->
    static List<int?> get manyMaybeUInt64 =>
        check((exn) =>
            consumeCreatedRef<List<int?>>(f__dart_get_Primitives_manyMaybeUInt64(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyMaybeInt8) -->
    static List<int?> get manyMaybeInt8 =>
        check((exn) =>
            consumeCreatedRef<List<int?>>(f__dart_get_Primitives_manyMaybeInt8(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyMaybeInt16) -->
    static List<int?> get manyMaybeInt16 =>
        check((exn) =>
            consumeCreatedRef<List<int?>>(f__dart_get_Primitives_manyMaybeInt16(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyMaybeInt32) -->
    static List<int?> get manyMaybeInt32 =>
        check((exn) =>
            consumeCreatedRef<List<int?>>(f__dart_get_Primitives_manyMaybeInt32(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyMaybeInt64) -->
    static List<int?> get manyMaybeInt64 =>
        check((exn) =>
            consumeCreatedRef<List<int?>>(f__dart_get_Primitives_manyMaybeInt64(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyMaybeFloat) -->
    static List<double?> get manyMaybeFloat =>
        check((exn) =>
            consumeCreatedRef<List<double?>>(f__dart_get_Primitives_manyMaybeFloat(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(manyMaybeDouble) -->
    static List<double?> get manyMaybeDouble =>
        check((exn) =>
            consumeCreatedRef<List<double?>>(f__dart_get_Primitives_manyMaybeDouble(Loader.shared.env, exn))
        )
    ;
    /// <!-- FishyJoes.export(defaultPrimitiveHolder) -->
    static TestAPI.Primitives_PrimitiveHolder get defaultPrimitiveHolder =>
        check((exn) =>
            consumeCreatedRef<TestAPI.Primitives_PrimitiveHolder>(f__dart_get_Primitives_defaultPrimitiveHolder(Loader.shared.env, exn))
        )
    ;
    ...
    static bool echoBool(
        ...
        check((OutCreatedRef _exn) => f__dart_Primitives_echoBool(Loader.shared.env, value, _exn))
    ;
    ...
    static int echoUInt8(
        ...
        check((OutCreatedRef _exn) => f__dart_Primitives_echoUInt8(Loader.shared.env, value, _exn))
    ;
    ...
    static int echoUInt16(
        ...
        check((OutCreatedRef _exn) => f__dart_Primitives_echoUInt16(Loader.shared.env, value, _exn))
    ;
    ...
    static int echoUInt32(
        ...
        check((OutCreatedRef _exn) => f__dart_Primitives_echoUInt32(Loader.shared.env, value, _exn))
    ;
    ...
    static int echoUInt64(
        ...
        check((OutCreatedRef _exn) => f__dart_Primitives_echoUInt64(Loader.shared.env, value, _exn))
    ;
    ...
    static int echoInt8(
        ...
        check((OutCreatedRef _exn) => f__dart_Primitives_echoInt8(Loader.shared.env, value, _exn))
    ;
    ...
    static int echoInt16(
        ...
        check((OutCreatedRef _exn) => f__dart_Primitives_echoInt16(Loader.shared.env, value, _exn))
    ;
    ...
    static int echoInt32(
        ...
        check((OutCreatedRef _exn) => f__dart_Primitives_echoInt32(Loader.shared.env, value, _exn))
    ;
    ...
    static int echoInt64(
        ...
        check((OutCreatedRef _exn) => f__dart_Primitives_echoInt64(Loader.shared.env, value, _exn))
    ;
    ...
    static double echoFloat(
        ...
        check((OutCreatedRef _exn) => f__dart_Primitives_echoFloat(Loader.shared.env, value, _exn))
    ;
    ...
    static double echoDouble(
        ...
        check((OutCreatedRef _exn) => f__dart_Primitives_echoDouble(Loader.shared.env, value, _exn))
    ;
    ...
    static bool? maybeEchoBool(
        ...
        GCRef.using(value, (_valueHandle) =>
            consumeCreatedRef<bool?>(check((OutCreatedRef _exn) => f__dart_Primitives_maybeEchoBool(Loader.shared.env, _valueHandle.ptr, _exn)))
        )
    ;
    ...
    static int? maybeEchoUInt8(
        ...
        GCRef.using(value, (_valueHandle) =>
            consumeCreatedRef<int?>(check((OutCreatedRef _exn) => f__dart_Primitives_maybeEchoUInt8(Loader.shared.env, _valueHandle.ptr, _exn)))
        )
    ;
    ...
    static int? maybeEchoUInt16(
        ...
        GCRef.using(value, (_valueHandle) =>
            consumeCreatedRef<int?>(check((OutCreatedRef _exn) => f__dart_Primitives_maybeEchoUInt16(Loader.shared.env, _valueHandle.ptr, _exn)))
        )
    ;
    ...
    static int? maybeEchoUInt32(
        ...
        GCRef.using(value, (_valueHandle) =>
            consumeCreatedRef<int?>(check((OutCreatedRef _exn) => f__dart_Primitives_maybeEchoUInt32(Loader.shared.env, _valueHandle.ptr, _exn)))
        )
    ;
    ...
    static int? maybeEchoUInt64(
        ...
        GCRef.using(value, (_valueHandle) =>
            consumeCreatedRef<int?>(check((OutCreatedRef _exn) => f__dart_Primitives_maybeEchoUInt64(Loader.shared.env, _valueHandle.ptr, _exn)))
        )
    ;
    ...
    static int? maybeEchoInt8(
        ...
        GCRef.using(value, (_valueHandle) =>
            consumeCreatedRef<int?>(check((OutCreatedRef _exn) => f__dart_Primitives_maybeEchoInt8(Loader.shared.env, _valueHandle.ptr, _exn)))
        )
    ;
    ...
    static int? maybeEchoInt16(
        ...
        GCRef.using(value, (_valueHandle) =>
            consumeCreatedRef<int?>(check((OutCreatedRef _exn) => f__dart_Primitives_maybeEchoInt16(Loader.shared.env, _valueHandle.ptr, _exn)))
        )
    ;
    ...
    static int? maybeEchoInt32(
        ...
        GCRef.using(value, (_valueHandle) =>
            consumeCreatedRef<int?>(check((OutCreatedRef _exn) => f__dart_Primitives_maybeEchoInt32(Loader.shared.env, _valueHandle.ptr, _exn)))
        )
    ;
    ...
    static int? maybeEchoInt64(
        ...
        GCRef.using(value, (_valueHandle) =>
            consumeCreatedRef<int?>(check((OutCreatedRef _exn) => f__dart_Primitives_maybeEchoInt64(Loader.shared.env, _valueHandle.ptr, _exn)))
        )
    ;
    ...
    static double? maybeEchoFloat(
        ...
        GCRef.using(value, (_valueHandle) =>
            consumeCreatedRef<double?>(check((OutCreatedRef _exn) => f__dart_Primitives_maybeEchoFloat(Loader.shared.env, _valueHandle.ptr, _exn)))
        )
    ;
    ...
    static double? maybeEchoDouble(
        ...
        GCRef.using(value, (_valueHandle) =>
            consumeCreatedRef<double?>(check((OutCreatedRef _exn) => f__dart_Primitives_maybeEchoDouble(Loader.shared.env, _valueHandle.ptr, _exn)))
        )
    ;
    ...
    static int? valueMapper(
        ...
        GCRef.using(value, (_valueHandle) =>
            GCRef.using(mapper, (_mapperHandle) =>
                consumeCreatedRef<int?>(check((OutCreatedRef _exn) => f__dart_Primitives_valueMapper(Loader.shared.env, _valueHandle.ptr, _mapperHandle.ptr, _exn)))
            )
        )
    ;
    ...
    static late CreatedRef Function(
        ...
        UnownedRef value,
        OutCreatedRef _exn
    ) f__dart_Primitives_maybeEchoBool;
    static late CreatedRef Function(
        Env env,
        UnownedRef value,
        OutCreatedRef _exn
    ...
    static late CreatedRef Function(
        Env env,
        OutCreatedRef _exn
    ) f__dart_get_Primitives_manyUInt64;
    static late CreatedRef Function(
        Env env,
        OutCreatedRef _exn
    ...
    static late int Function(
        Env env,
        OutCreatedRef _exn
    ) f__dart_get_Primitives_minUInt32;
    static late int Function(
        Env env,
        OutCreatedRef _exn
    ) f__dart_get_Primitives_minUInt64;
    static late int Function(
        Env env,
        OutCreatedRef _exn

...
abstract class TestLeadingUnderscoredMethod {
    String _leadingUnderscoreMethod(
    );
}

extension TestLeadingUnderscoredMethod_DefaultImplementations on TestLeadingUnderscoredMethod {
}

extension TestLeadingUnderscoredMethod_FfiHooks on TestLeadingUnderscoredMethod {
    static CreatedRef ffi__leadingUnderscoreMethod(
        UnownedRef obj,
        OutCreatedRef exn
    ) => catchingRef(exn, () =>
        createRef(
            peekRef<TestLeadingUnderscoredMethod>(obj)._leadingUnderscoreMethod(
            )
        )
    );
}

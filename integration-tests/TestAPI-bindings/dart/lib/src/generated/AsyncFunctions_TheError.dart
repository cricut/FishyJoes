...
class AsyncFunctions_TheError extends SwiftReference {
    AsyncFunctions_TheError(ffi.Pointer reference): super(reference) {}
    static CreatedRef ffi_new(ffi.Pointer ref, OutCreatedRef exn) => check((exn) =>
        createRef(AsyncFunctions_TheError(ref))
    );
}

...
class ExternalWitness_TestLeadingUnderscoredMethod extends SwiftReference implements TestAPI.TestLeadingUnderscoredMethod {
    ExternalWitness_TestLeadingUnderscoredMethod(ffi.Pointer reference): super(reference) {}
    static CreatedRef ffi_new(ffi.Pointer ref, OutCreatedRef exn) => check((exn) =>
        createRef(ExternalWitness_TestLeadingUnderscoredMethod(ref))
    );

    @override
    String toString() => 'ExternalWitness_TestLeadingUnderscoredMethod()';

    static late CreatedRef Function(
        Env env,
        UnownedRef _this,
        OutCreatedRef _exn
    ) f__iota_TestAPI_TestLeadingUnderscoredMethod__leadingUnderscoreMethod;
}

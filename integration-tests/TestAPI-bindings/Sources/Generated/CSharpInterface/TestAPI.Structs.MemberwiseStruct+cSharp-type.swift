...
public func TestAPI_Structs_MemberwiseStruct_setup(
    ...
    guard TestAPI.Structs.MemberwiseStruct._constructorMethod == nil else { return }
    TestAPI.Structs.MemberwiseStruct._constructorMethod = constructorMethod
    TestAPI.Structs.MemberwiseStruct._immutableGetter = immutableGetter
    TestAPI.Structs.MemberwiseStruct._immutableSetter = immutableSetter
    TestAPI.Structs.MemberwiseStruct._mutableGetter = mutableGetter
    TestAPI.Structs.MemberwiseStruct._mutableSetter = mutableSetter
}

extension TestAPI.Structs.MemberwiseStruct: CSharpMutator {

...
public func TestAPI_SimpleEnum_setup(
    ...
    TestAPI.SimpleEnum.discriminator = discriminator
    TestAPI.SimpleEnum.red_constructor = red_constructor
    TestAPI.SimpleEnum.red_extractor = red_extractor
    TestAPI.SimpleEnum.green_constructor = green_constructor
    TestAPI.SimpleEnum.green_extractor = green_extractor
    TestAPI.SimpleEnum.blue_constructor = blue_constructor
    TestAPI.SimpleEnum.blue_extractor = blue_extractor
}

extension TestAPI.SimpleEnum: CSharpConverter {

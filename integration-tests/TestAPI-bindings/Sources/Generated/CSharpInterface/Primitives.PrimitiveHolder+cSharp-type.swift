...
extension Primitives.PrimitiveHolder: CSharpMutator {
    ...
    public static func mutateCSharp<R>(_ this: csObject, body: (inout Self) throws -> R) throws -> R {
        ...
        try Env.check { exn in _bSetter(
            this,
            try Bool.toCSharp(mutatingSelf.b),
            exn
        )}
        try Env.check { exn in _bqSetter(
            this,
            try OptionalConverter<Bool>.toCSharp(mutatingSelf.bq),
            exn
        )}
        try Env.check { exn in _ui8Setter(
            this,
            try UInt8.toCSharp(mutatingSelf.ui8),
            exn
        )}
        try Env.check { exn in _ui8qSetter(
            this,
            try OptionalConverter<UInt8>.toCSharp(mutatingSelf.ui8q),
            exn
        )}
        try Env.check { exn in _ui16Setter(
            this,
            try UInt16.toCSharp(mutatingSelf.ui16),
            exn
        )}
        try Env.check { exn in _ui16qSetter(
            this,
            try OptionalConverter<UInt16>.toCSharp(mutatingSelf.ui16q),
            exn
        )}
        try Env.check { exn in _ui32Setter(
            this,
            try UInt32.toCSharp(mutatingSelf.ui32),
            exn
        )}
        try Env.check { exn in _ui32qSetter(
            this,
            try OptionalConverter<UInt32>.toCSharp(mutatingSelf.ui32q),
            exn
        )}
        try Env.check { exn in _ui64Setter(
            this,
            try UInt64.toCSharp(mutatingSelf.ui64),
            exn
        )}
        ...
        try Env.check { exn in _i8qSetter(
            this,
            try OptionalConverter<Int8>.toCSharp(mutatingSelf.i8q),
            exn
        )}
        try Env.check { exn in _i16Setter(
            this,
            try Int16.toCSharp(mutatingSelf.i16),
            exn
        )}
        try Env.check { exn in _i16qSetter(
            this,
            try OptionalConverter<Int16>.toCSharp(mutatingSelf.i16q),
            exn
        )}
        try Env.check { exn in _i32Setter(
            this,
            try Int32.toCSharp(mutatingSelf.i32),
            exn
        )}
        try Env.check { exn in _i32qSetter(
            this,
            try OptionalConverter<Int32>.toCSharp(mutatingSelf.i32q),
            exn
        )}
        try Env.check { exn in _i64Setter(
            this,
            try Int64.toCSharp(mutatingSelf.i64),
            exn
        )}
        ...
        try Env.check { exn in _fSetter(
            this,
            try Float.toCSharp(mutatingSelf.f),
            exn
        )}
        try Env.check { exn in _fqSetter(
            this,
            try OptionalConverter<Float>.toCSharp(mutatingSelf.fq),
            exn
        )}
        try Env.check { exn in _dSetter(
            this,
            try Double.toCSharp(mutatingSelf.d),
            exn
        )}
        try Env.check { exn in _dqSetter(
            this,
            try OptionalConverter<Double>.toCSharp(mutatingSelf.dq),
            exn
        )}
        return result
    }

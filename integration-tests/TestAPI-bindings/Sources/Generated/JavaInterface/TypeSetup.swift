...
public func jniOnLoad(vm: UnsafeMutablePointer<JavaVM?>, reserved: UnsafeMutableRawPointer) -> jint {
    ...
    return FishyJoesJavaRuntime.callbackBody(env!) { env in
        ...
        try DictionaryConverter<Int, OptionalConverter<Int>>.javaSetup(env: env)
        ...
        // print("setting up OptionalConverter<DictionaryConverter<Int, OptionalConverter<Int>>>...")
        try OptionalConverter<DictionaryConverter<Int, OptionalConverter<Int>>>.javaSetup(env: env)
        ...
        try env.RegisterNatives(AttributeContainerASDF.javaClass,
            ...
            JNINativeMethod(
                ...
                signature: bag.add("(Lcom/cricut/testapi/AttributeContainer;Lcom/cricut/testapi/AttributeContainer;)Z"),
                fnPtr: unsafeBitCast(AttributeContainerASDF._javaEquals, to: UnsafeMutableRawPointer.self)
            ),
            JNINativeMethod(
                name: bag.add("__jni_hashCode"),
                signature: bag.add("()I"),
                fnPtr: unsafeBitCast(AttributeContainerASDF._javaHash, to: UnsafeMutableRawPointer.self)
            )
        )
        ...
        try env.RegisterNatives(AttributedStringASDF.AttributeMergePolicy.javaClass,
            JNINativeMethod(
                name: bag.add("__jni_swiftEquals"),
                signature: bag.add("(Lcom/cricut/testapi/AttributedString$AttributeMergePolicy;Lcom/cricut/testapi/AttributedString$AttributeMergePolicy;)Z"),
                fnPtr: unsafeBitCast(AttributedStringASDF.AttributeMergePolicy._javaEquals, to: UnsafeMutableRawPointer.self)
            ),
            JNINativeMethod(
                name: bag.add("__jni_hashCode"),
                signature: bag.add("()I"),
                fnPtr: unsafeBitCast(AttributedStringASDF.AttributeMergePolicy._javaHash, to: UnsafeMutableRawPointer.self)
            )
        )
        ...
        try env.RegisterNatives(AttributedStrings.javaClass,
            JNINativeMethod(
                ...
                signature: bag.add("(Lcom/cricut/testapi/AttributedString;)Lcom/cricut/testapi/AttributedString;"),
        ...
        try env.RegisterNatives(Collections.javaClass,
            ...
            JNINativeMethod(
                ...
                signature: bag.add("()Ljava/util/Map;"),
                fnPtr: unsafeBitCast(java_get_Collections_maybeDictionaryOfIntToMaybeInt, to: UnsafeMutableRawPointer.self)
            ),
            JNINativeMethod(
        ...
        try env.RegisterNatives(AttributedStringASDF.Runs.Run.javaClass,
            ...
            JNINativeMethod(
                name: bag.add("__jni_swiftEquals"),
                signature: bag.add("(Lcom/cricut/testapi/AttributedString$Runs$Run;Lcom/cricut/testapi/AttributedString$Runs$Run;)Z"),
                fnPtr: unsafeBitCast(AttributedStringASDF.Runs.Run._javaEquals, to: UnsafeMutableRawPointer.self)
            ),
            JNINativeMethod(
                name: bag.add("__jni_hashCode"),
                signature: bag.add("()I"),
                fnPtr: unsafeBitCast(AttributedStringASDF.Runs.Run._javaHash, to: UnsafeMutableRawPointer.self)
            )
        )
        ...
        try env.RegisterNatives(AttributedStringASDF.Runs.javaClass,
            ...
            JNINativeMethod(
                name: bag.add("__jni_swiftEquals"),
                signature: bag.add("(Lcom/cricut/testapi/AttributedString$Runs;Lcom/cricut/testapi/AttributedString$Runs;)Z"),
                fnPtr: unsafeBitCast(AttributedStringASDF.Runs._javaEquals, to: UnsafeMutableRawPointer.self)
            ),
            JNINativeMethod(
                name: bag.add("__jni_hashCode"),
                signature: bag.add("()I"),
                fnPtr: unsafeBitCast(AttributedStringASDF.Runs._javaHash, to: UnsafeMutableRawPointer.self)
            )
        )

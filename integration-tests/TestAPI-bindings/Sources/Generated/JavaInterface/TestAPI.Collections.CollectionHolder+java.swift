...
extension TestAPI.Collections.CollectionHolder: JavaMutator {
    ...
    public static func javaSetup(env: Env) throws {
        ...
        _constructorMethodID = try env.GetMethodID(javaClass, "<init>", "(Ljava/util/List;Ljava/util/Map;Ljava/util/Set;Ljava/util/List;Ljava/util/Map;Ljava/util/Set;Ljava/util/List;Ljava/util/Map;Ljava/util/Set;)V")
    }

...
extension Primitives.PrimitiveHolder: DartMutator {
    fileprivate static var _bGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> Bool.CType>()
    fileprivate static var _bSetter = Env.CallbackMap<@convention(c) (foreignObject, Bool.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _bqGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> OptionalConverter<Bool>.CType>()
    fileprivate static var _bqSetter = Env.CallbackMap<@convention(c) (foreignObject, OptionalConverter<Bool>.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _ui8Getter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> UInt8.CType>()
    fileprivate static var _ui8Setter = Env.CallbackMap<@convention(c) (foreignObject, UInt8.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _ui8qGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> OptionalConverter<UInt8>.CType>()
    fileprivate static var _ui8qSetter = Env.CallbackMap<@convention(c) (foreignObject, OptionalConverter<UInt8>.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _ui16Getter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> UInt16.CType>()
    fileprivate static var _ui16Setter = Env.CallbackMap<@convention(c) (foreignObject, UInt16.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _ui16qGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> OptionalConverter<UInt16>.CType>()
    fileprivate static var _ui16qSetter = Env.CallbackMap<@convention(c) (foreignObject, OptionalConverter<UInt16>.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _ui32Getter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> UInt32.CType>()
    fileprivate static var _ui32Setter = Env.CallbackMap<@convention(c) (foreignObject, UInt32.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _ui32qGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> OptionalConverter<UInt32>.CType>()
    fileprivate static var _ui32qSetter = Env.CallbackMap<@convention(c) (foreignObject, OptionalConverter<UInt32>.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _ui64Getter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> UInt64.CType>()
    fileprivate static var _ui64Setter = Env.CallbackMap<@convention(c) (foreignObject, UInt64.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _ui64qGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> OptionalConverter<UInt64>.CType>()
    fileprivate static var _ui64qSetter = Env.CallbackMap<@convention(c) (foreignObject, OptionalConverter<UInt64>.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _i8Getter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> Int8.CType>()
    fileprivate static var _i8Setter = Env.CallbackMap<@convention(c) (foreignObject, Int8.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _i8qGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> OptionalConverter<Int8>.CType>()
    fileprivate static var _i8qSetter = Env.CallbackMap<@convention(c) (foreignObject, OptionalConverter<Int8>.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _i16Getter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> Int16.CType>()
    fileprivate static var _i16Setter = Env.CallbackMap<@convention(c) (foreignObject, Int16.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _i16qGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> OptionalConverter<Int16>.CType>()
    fileprivate static var _i16qSetter = Env.CallbackMap<@convention(c) (foreignObject, OptionalConverter<Int16>.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _i32Getter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> Int32.CType>()
    fileprivate static var _i32Setter = Env.CallbackMap<@convention(c) (foreignObject, Int32.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _i32qGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> OptionalConverter<Int32>.CType>()
    fileprivate static var _i32qSetter = Env.CallbackMap<@convention(c) (foreignObject, OptionalConverter<Int32>.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _i64Getter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> Int64.CType>()
    fileprivate static var _i64Setter = Env.CallbackMap<@convention(c) (foreignObject, Int64.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _i64qGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> OptionalConverter<Int64>.CType>()
    fileprivate static var _i64qSetter = Env.CallbackMap<@convention(c) (foreignObject, OptionalConverter<Int64>.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _fGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> Float.CType>()
    fileprivate static var _fSetter = Env.CallbackMap<@convention(c) (foreignObject, Float.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _fqGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> OptionalConverter<Float>.CType>()
    fileprivate static var _fqSetter = Env.CallbackMap<@convention(c) (foreignObject, OptionalConverter<Float>.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _dGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> Double.CType>()
    fileprivate static var _dSetter = Env.CallbackMap<@convention(c) (foreignObject, Double.CType, _ exn: foreignOutExn) -> Void>()
    fileprivate static var _dqGetter = Env.CallbackMap<@convention(c) (foreignObject, _ exn: foreignOutExn) -> OptionalConverter<Double>.CType>()
    fileprivate static var _dqSetter = Env.CallbackMap<@convention(c) (foreignObject, OptionalConverter<Double>.CType, _ exn: foreignOutExn) -> Void>()
    ...
    public static func toDart(_ value: Self, env: Env) throws -> foreignObject {
        try env.check { exn in
            _constructorMethod[env](
                try Bool.toDart(value.b, env: env),
                try OptionalConverter<Bool>.toDart(value.bq, env: env),
                try UInt8.toDart(value.ui8, env: env),
                try OptionalConverter<UInt8>.toDart(value.ui8q, env: env),
                try UInt16.toDart(value.ui16, env: env),
                try OptionalConverter<UInt16>.toDart(value.ui16q, env: env),
                try UInt32.toDart(value.ui32, env: env),
                try OptionalConverter<UInt32>.toDart(value.ui32q, env: env),
                try UInt64.toDart(value.ui64, env: env),
                try OptionalConverter<UInt64>.toDart(value.ui64q, env: env),
                try Int8.toDart(value.i8, env: env),
                try OptionalConverter<Int8>.toDart(value.i8q, env: env),
                try Int16.toDart(value.i16, env: env),
                try OptionalConverter<Int16>.toDart(value.i16q, env: env),
                try Int32.toDart(value.i32, env: env),
                try OptionalConverter<Int32>.toDart(value.i32q, env: env),
                try Int64.toDart(value.i64, env: env),
                try OptionalConverter<Int64>.toDart(value.i64q, env: env),
                try Float.toDart(value.f, env: env),
                try OptionalConverter<Float>.toDart(value.fq, env: env),
                try Double.toDart(value.d, env: env),
                try OptionalConverter<Double>.toDart(value.dq, env: env),
                exn
            )
        }
    }
    ...
    public static func mutateDart<R>(_ this: foreignObject, env: Env, body: (inout Self) throws -> R) throws -> R {
        ...
        try env.check { exn in _bSetter[env](
            this,
            try Bool.toDart(mutatingSelf.b, env: env),
            exn
        )}
        try env.check { exn in _bqSetter[env](
            this,
            try OptionalConverter<Bool>.toDart(mutatingSelf.bq, env: env),
            exn
        )}
        try env.check { exn in _ui8Setter[env](
            this,
            try UInt8.toDart(mutatingSelf.ui8, env: env),
            exn
        )}
        try env.check { exn in _ui8qSetter[env](
            this,
            try OptionalConverter<UInt8>.toDart(mutatingSelf.ui8q, env: env),
            exn
        )}
        try env.check { exn in _ui16Setter[env](
            this,
            try UInt16.toDart(mutatingSelf.ui16, env: env),
            exn
        )}
        try env.check { exn in _ui16qSetter[env](
            this,
            try OptionalConverter<UInt16>.toDart(mutatingSelf.ui16q, env: env),
            exn
        )}
        try env.check { exn in _ui32Setter[env](
            this,
            try UInt32.toDart(mutatingSelf.ui32, env: env),
            exn
        )}
        try env.check { exn in _ui32qSetter[env](
            this,
            try OptionalConverter<UInt32>.toDart(mutatingSelf.ui32q, env: env),
            exn
        )}
        try env.check { exn in _ui64Setter[env](
            this,
            try UInt64.toDart(mutatingSelf.ui64, env: env),
            exn
        )}
        try env.check { exn in _ui64qSetter[env](
            this,
            try OptionalConverter<UInt64>.toDart(mutatingSelf.ui64q, env: env),
            exn
        )}
        try env.check { exn in _i8Setter[env](
            this,
            try Int8.toDart(mutatingSelf.i8, env: env),
            exn
        )}
        try env.check { exn in _i8qSetter[env](
            this,
            try OptionalConverter<Int8>.toDart(mutatingSelf.i8q, env: env),
            exn
        )}
        try env.check { exn in _i16Setter[env](
            this,
            try Int16.toDart(mutatingSelf.i16, env: env),
            exn
        )}
        try env.check { exn in _i16qSetter[env](
            this,
            try OptionalConverter<Int16>.toDart(mutatingSelf.i16q, env: env),
            exn
        )}
        try env.check { exn in _i32Setter[env](
            this,
            try Int32.toDart(mutatingSelf.i32, env: env),
            exn
        )}
        try env.check { exn in _i32qSetter[env](
            this,
            try OptionalConverter<Int32>.toDart(mutatingSelf.i32q, env: env),
            exn
        )}
        try env.check { exn in _i64Setter[env](
            this,
            try Int64.toDart(mutatingSelf.i64, env: env),
            exn
        )}
        try env.check { exn in _i64qSetter[env](
            this,
            try OptionalConverter<Int64>.toDart(mutatingSelf.i64q, env: env),
            exn
        )}
        try env.check { exn in _fSetter[env](
            this,
            try Float.toDart(mutatingSelf.f, env: env),
            exn
        )}
        try env.check { exn in _fqSetter[env](
            this,
            try OptionalConverter<Float>.toDart(mutatingSelf.fq, env: env),
            exn
        )}
        try env.check { exn in _dSetter[env](
            this,
            try Double.toDart(mutatingSelf.d, env: env),
            exn
        )}
        try env.check { exn in _dqSetter[env](
            this,
            try OptionalConverter<Double>.toDart(mutatingSelf.dq, env: env),
            exn
        )}
        return result
    }

...
export declare namespace TestAPI {
    ...
    export namespace AttributedString {
         ...
         */
        export class AttributeMergePolicy {
            private constructor()
            private _inhibitStructuralTyping: any
        }
    ...
    export namespace AttributedStrings {
         ...
         */
        const accent: TestAPI.AttributedString;

        /**
         * <!-- FishyJoes.export(chinese) -->
         */
        const chinese: TestAPI.AttributedString;

        /**
         * <!-- FishyJoes.export(chineseBMP) -->
         */
        const chineseBMP: TestAPI.AttributedString;

        /**
         * <!-- FishyJoes.export(chineseSIP) -->
         */
        const chineseSIP: TestAPI.AttributedString;

        /**
         * <!-- FishyJoes.export(echo) -->
         */
        function echo(
            string: TestAPI.AttributedString
        ): TestAPI.AttributedString;

        /**
         * <!-- FishyJoes.export(emoji) -->
         */
        const emoji: TestAPI.AttributedString;

        /**
         * <!-- FishyJoes.export(emojiMulti) -->
         */
        const emojiMulti: TestAPI.AttributedString;

        /**
         * <!-- FishyJoes.export(script) -->
         */
        const script: TestAPI.AttributedString;

        /**
         * <!-- FishyJoes.export(simple) -->
         */
        const simple: TestAPI.AttributedString;
    }

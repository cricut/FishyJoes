...
public func registerModuleTestAPI(env: NAPI.Env, exports: NAPI.Value) throws -> NAPI.Value {
    ...
    try TestAPI.TestMutatingCounter.nodeSetup(env: env, module: module)
    try TestAPI_CommonInterface._TestMutatingCounterProtocolConverter.nodeSetup(env: env, module: module)

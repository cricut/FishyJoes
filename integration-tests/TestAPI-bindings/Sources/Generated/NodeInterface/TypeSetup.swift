...
public func registerModuleTestAPI(env: NAPI.Env, exports: NAPI.Value) throws -> NAPI.Value {
    ...
    try AttributeContainerASDF.nodeSetup(env: env, module: module)
    try AttributedStringASDF.AttributeMergePolicy.nodeSetup(env: env, module: module)
    try AttributeScopeASDF.nodeSetup(env: env, module: module)
    try AttributedString.nodeSetup(env: env, module: module)
    try AttributedStringASDF.nodeSetup(env: env, module: module)
    try AttributedStrings.nodeSetup(env: env, module: module)
    try AttributedSubstringASDF.nodeSetup(env: env, module: module)
    try Bool.nodeSetup(env: env, module: module)
    try Bytes.nodeSetup(env: env, module: module)
    try AttributedStringASDF.CharacterView.nodeSetup(env: env, module: module)
    ...
    try AttributedStringASDF.Runs.Index.nodeSetup(env: env, module: module)
    try AttributedStringASDF.Index.nodeSetup(env: env, module: module)
    ...
    try AttributedStringASDF.Runs.Run.nodeSetup(env: env, module: module)
    try AttributedStringASDF.Runs.nodeSetup(env: env, module: module)
    ...
    try AttributedStringASDF.UnicodeScalarView.nodeSetup(env: env, module: module)
    return exports
}

        ...
        let nodeClass = try NodeClass(
            ...
            constructor: { env, info in
                callbackBody(env, info, name: "Primitives.PrimitiveHolder_constructor", expectedArgumentCount: 26) { env in
                    ...
                    try env.env.setNamedProperty(this, "d", env.argument(at: 2))
                    try env.env.setNamedProperty(this, "dq", env.argument(at: 3))
                    try env.env.setNamedProperty(this, "f", env.argument(at: 4))
                    try env.env.setNamedProperty(this, "fq", env.argument(at: 5))
                    try env.env.setNamedProperty(this, "i", env.argument(at: 6))
                    try env.env.setNamedProperty(this, "i16", env.argument(at: 7))
                    try env.env.setNamedProperty(this, "i16q", env.argument(at: 8))
                    try env.env.setNamedProperty(this, "i32", env.argument(at: 9))
                    try env.env.setNamedProperty(this, "i32q", env.argument(at: 10))
                    try env.env.setNamedProperty(this, "i64", env.argument(at: 11))
                    try env.env.setNamedProperty(this, "i64q", env.argument(at: 12))
                    try env.env.setNamedProperty(this, "i8", env.argument(at: 13))
                    try env.env.setNamedProperty(this, "i8q", env.argument(at: 14))
                    try env.env.setNamedProperty(this, "iq", env.argument(at: 15))
                    try env.env.setNamedProperty(this, "ui", env.argument(at: 16))
                    try env.env.setNamedProperty(this, "ui16", env.argument(at: 17))
                    try env.env.setNamedProperty(this, "ui16q", env.argument(at: 18))
                    try env.env.setNamedProperty(this, "ui32", env.argument(at: 19))
                    try env.env.setNamedProperty(this, "ui32q", env.argument(at: 20))
                    try env.env.setNamedProperty(this, "ui64", env.argument(at: 21))
                    try env.env.setNamedProperty(this, "ui64q", env.argument(at: 22))
                    try env.env.setNamedProperty(this, "ui8", env.argument(at: 23))
                    try env.env.setNamedProperty(this, "ui8q", env.argument(at: 24))
                    try env.env.setNamedProperty(this, "uiq", env.argument(at: 25))
                    return this
                }
            }
        )

        ...
        let nodeClass = try NodeClass(
            ...
            constructor: { env, info in
                callbackBody(env, info, name: "Collections.CollectionHolder_constructor", expectedArgumentCount: 9) { env in
                    ...
                    try env.env.setNamedProperty(this, "boolDictionary", env.argument(at: 1))
                    try env.env.setNamedProperty(this, "boolSet", env.argument(at: 2))
                    try env.env.setNamedProperty(this, "integerArray", env.argument(at: 3))
                    try env.env.setNamedProperty(this, "integerDictionary", env.argument(at: 4))
                    try env.env.setNamedProperty(this, "integerSet", env.argument(at: 5))
                    try env.env.setNamedProperty(this, "stringArray", env.argument(at: 6))
                    try env.env.setNamedProperty(this, "stringDictionary", env.argument(at: 7))
                    try env.env.setNamedProperty(this, "stringSet", env.argument(at: 8))
                    return this
                }
            }
        )

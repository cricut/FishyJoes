...
@_cdecl("__iota_TestAPI_TestProtocolStruct_wibble")
public func __iota_TestAPI_TestProtocolStruct_wibble(
    envRef: EnvRef,
    _exn: foreignOutExn
) -> Swift.String.CType {
    let env = Env(envRef)
...
@_cdecl("__iota_get_TestAPI_TestProtocolStruct_frob")
public func __iota_get_TestAPI_TestProtocolStruct_frob(
    envRef: EnvRef,
    _iotaThis: foreignObject,
    _exn: foreignOutExn
...
@_cdecl("__iota_get_TestAPI_TestProtocolStruct_blarg")
public func __iota_get_TestAPI_TestProtocolStruct_blarg(
    envRef: EnvRef,
    _exn: foreignOutExn
) -> Swift.String.CType {
    let env = Env(envRef)

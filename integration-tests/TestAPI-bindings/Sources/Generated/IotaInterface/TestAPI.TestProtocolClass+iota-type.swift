...
extension TestAPI.TestProtocolClass: IotaMutator {
    ...
    public static func mutateIota<R>(_ this: foreignObject, env: Env, body: (inout TestAPI.TestProtocolClass) throws -> R) throws -> R {
        try body(&Box<TestAPI.TestProtocolClass>.peekIota(this, env: env).value)
    }
}

...
extension TestAPI.Primitives.PrimitiveHolder: IotaMutator {
    ...
    public static func mutateIota<R>(_ this: foreignObject, env: Env, body: (inout Self) throws -> R) throws -> R {
        ...
        try env.check { exn in _bSetter[env](
            this,
            try Swift.Bool.toIota(mutatingSelf.b, env: env),
            exn
        )}
        try env.check { exn in _bqSetter[env](
            this,
            try OptionalConverter<Swift.Bool>.toIota(mutatingSelf.bq, env: env),
            exn
        )}
        try env.check { exn in _ui8Setter[env](
            this,
            try Swift.UInt8.toIota(mutatingSelf.ui8, env: env),
            exn
        )}
        try env.check { exn in _ui8qSetter[env](
            this,
            try OptionalConverter<Swift.UInt8>.toIota(mutatingSelf.ui8q, env: env),
            exn
        )}
        try env.check { exn in _ui16Setter[env](
            this,
            try Swift.UInt16.toIota(mutatingSelf.ui16, env: env),
            exn
        )}
        try env.check { exn in _ui16qSetter[env](
            this,
            try OptionalConverter<Swift.UInt16>.toIota(mutatingSelf.ui16q, env: env),
            exn
        )}
        try env.check { exn in _ui32Setter[env](
            this,
            try Swift.UInt32.toIota(mutatingSelf.ui32, env: env),
            exn
        )}
        try env.check { exn in _ui32qSetter[env](
            this,
            try OptionalConverter<Swift.UInt32>.toIota(mutatingSelf.ui32q, env: env),
            exn
        )}
        try env.check { exn in _ui64Setter[env](
            this,
            try Swift.UInt64.toIota(mutatingSelf.ui64, env: env),
            exn
        )}
        try env.check { exn in _ui64qSetter[env](
            this,
            try OptionalConverter<Swift.UInt64>.toIota(mutatingSelf.ui64q, env: env),
            exn
        )}
        try env.check { exn in _uiSetter[env](
            this,
            try Swift.UInt.toIota(mutatingSelf.ui, env: env),
            exn
        )}
        try env.check { exn in _uiqSetter[env](
            this,
            try OptionalConverter<Swift.UInt>.toIota(mutatingSelf.uiq, env: env),
            exn
        )}
        try env.check { exn in _i8Setter[env](
            this,
            try Swift.Int8.toIota(mutatingSelf.i8, env: env),
            exn
        )}
        try env.check { exn in _i8qSetter[env](
            this,
            try OptionalConverter<Swift.Int8>.toIota(mutatingSelf.i8q, env: env),
            exn
        )}
        try env.check { exn in _i16Setter[env](
            this,
            try Swift.Int16.toIota(mutatingSelf.i16, env: env),
            exn
        )}
        try env.check { exn in _i16qSetter[env](
            this,
            try OptionalConverter<Swift.Int16>.toIota(mutatingSelf.i16q, env: env),
            exn
        )}
        try env.check { exn in _i32Setter[env](
            this,
            try Swift.Int32.toIota(mutatingSelf.i32, env: env),
            exn
        )}
        try env.check { exn in _i32qSetter[env](
            this,
            try OptionalConverter<Swift.Int32>.toIota(mutatingSelf.i32q, env: env),
            exn
        )}
        try env.check { exn in _i64Setter[env](
            this,
            try Swift.Int64.toIota(mutatingSelf.i64, env: env),
            exn
        )}
        try env.check { exn in _i64qSetter[env](
            this,
            try OptionalConverter<Swift.Int64>.toIota(mutatingSelf.i64q, env: env),
            exn
        )}
        ...
        try env.check { exn in _iqSetter[env](
            this,
            try OptionalConverter<Swift.Int>.toIota(mutatingSelf.iq, env: env),
            exn
        )}
        try env.check { exn in _fSetter[env](
            this,
            try Swift.Float.toIota(mutatingSelf.f, env: env),
            exn
        )}
        try env.check { exn in _fqSetter[env](
            this,
            try OptionalConverter<Swift.Float>.toIota(mutatingSelf.fq, env: env),
            exn
        )}
        try env.check { exn in _dSetter[env](
            this,
            try Swift.Double.toIota(mutatingSelf.d, env: env),
            exn
        )}
        try env.check { exn in _dqSetter[env](
            this,
            try OptionalConverter<Swift.Double>.toIota(mutatingSelf.dq, env: env),
            exn
        )}
        return result
    }

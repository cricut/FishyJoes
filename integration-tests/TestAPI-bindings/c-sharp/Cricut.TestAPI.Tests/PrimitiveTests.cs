...
namespace Cricut.TestAPI.Tests {
    public class PrimitiveTests {
        ...
        void testPrimitiveValues() {
            ...
            Assert.Equal(ulong.MinValue, Primitives.MinUInt);
            Assert.Equal(ulong.MaxValue, Primitives.MaxUInt);
            ...
            Assert.Equal(long.MinValue, Primitives.MinInt);
            Assert.Equal(long.MaxValue, Primitives.MaxInt);
        ...
        void testArraysOfPrimitiveValues() {
            ...
            Assert.Equal(new ulong[] { 0u, ulong.MinValue, ulong.MaxValue }, Primitives.ManyUInt);
            ...
            Assert.Equal(new long[] { 0, long.MinValue, long.MaxValue }, Primitives.ManyInt);
        ...
        void testArraysOfOptionalPrimitiveValues() {
            ...
            Assert.Equal(new ulong?[] { null, 0, ulong.MinValue, ulong.MaxValue }, Primitives.ManyMaybeUInt);
            ...
            Assert.Equal(new long?[] { null, 0, long.MinValue, long.MaxValue }, Primitives.ManyMaybeInt);
        ...
        void testFunctionsTakingAndReturningPrimitiveTypes() {
            ...
            Assert.Equal(ulong.MinValue, Primitives.EchoUInt(ulong.MinValue));
            Assert.Equal(ulong.MaxValue, Primitives.EchoUInt(ulong.MaxValue));
            ...
            Assert.Equal(long.MinValue, Primitives.EchoInt(long.MinValue));
            Assert.Equal(long.MaxValue, Primitives.EchoInt(long.MaxValue));
        ...
        void testFunctionsTakingReturningOptionalPrimitiveTypes() {
            ...
            Assert.Equal(ulong.MinValue, Primitives.MaybeEchoUInt(ulong.MinValue));
            Assert.Equal(ulong.MaxValue, Primitives.MaybeEchoUInt(ulong.MaxValue));
            ...
            Assert.Equal(long.MinValue, Primitives.MaybeEchoInt(long.MinValue));
            Assert.Equal(long.MaxValue, Primitives.MaybeEchoInt(long.MaxValue));

...
namespace Cricut.TestAPI {
    ...
    public record Structs {
        ...
        public class ReferenceStruct : SwiftReference {
            ...
            public string Immutable {
                ...
                set {
                    ...
                    Check((out CreatedRef exn) =>
                        __iota_set_Structs_ReferenceStruct_Immutable(thisHandle.ptr, valueHandle.ptr, out exn)
                    );
                }
            }
            ...
            [DllImport("TestAPI-iota", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
            private static extern void __iota_set_Structs_ReferenceStruct_Immutable(UnownedRef self, UnownedRef value, out CreatedRef exn);
        ...
        public class ReferenceStruct : SwiftReference {
            ...
            public override bool Equals(
                ...
                using var thisHandle = new GCRef(this);
                using var otherHandle = new GCRef(other as Cricut.TestAPI.Structs.ReferenceStruct);
                return Check((out CreatedRef exn) => __dart_Structs_ReferenceStruct_equals(thisHandle.ptr, otherHandle.ptr, out exn));
            }

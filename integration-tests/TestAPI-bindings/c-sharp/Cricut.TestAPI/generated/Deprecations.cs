...
namespace Cricut.TestAPI {
    ...
    public record Deprecations {
        ...
        public static nint DeprecatedVariable {
            get {
                return Check((out CreatedRef exn) =>
                    __iota_get_Deprecations_deprecatedVariable(Loader.env, out exn)
                );
            }
        }

        [DllImport("TestAPI-iota", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        private static extern nint __iota_get_Deprecations_deprecatedVariable(IntPtr envRef, out CreatedRef exn);
        ...
        public static string DeprecatedMethod(
            ...
            return Check((out CreatedRef _exn) => __iota_Deprecations_deprecatedMethod(Loader.env, out _exn)).Consume<string>();
        }

...
namespace Cricut.TestAPI {
    ...
    public record EmptyEnum {
        ...
        public static Cricut.TestAPI.EmptyEnum NotGoingToHappen(
            ...
            return Check((out CreatedRef _exn) => __cs_TestAPI_EmptyEnum_notGoingToHappen(out _exn)).Consume<Cricut.TestAPI.EmptyEnum>();
        }

        [DllImport("TestAPI-c-sharp", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        private static extern CreatedRef __cs_TestAPI_EmptyEnum_notGoingToHappen(
            out CreatedRef exn
        );

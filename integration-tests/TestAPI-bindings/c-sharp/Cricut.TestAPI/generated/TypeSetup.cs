...
namespace Cricut.TestAPI {
    public class _TypeSetup {
        ...
        delegate CreatedRef Cricut_TestAPI_AttributedString_AttributeMergePolicy_new_keepNew(
            out CreatedRef _exn
        );
        unsafe delegate void Cricut_TestAPI_AttributedString_AttributeMergePolicy_extract_keepNew(
            UnownedRef obj,
            out CreatedRef _exn
        );
        delegate CreatedRef Cricut_TestAPI_AttributedString_AttributeMergePolicy_new_keepCurrent(
            out CreatedRef _exn
        );
        unsafe delegate void Cricut_TestAPI_AttributedString_AttributeMergePolicy_extract_keepCurrent(
            UnownedRef obj,
            out CreatedRef _exn
        );
        [DllImport("TestAPI-c-sharp", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        static extern void TestAPI_AttributedStringASDF_AttributeMergePolicy_setup(
            FishyJoesRuntime.EnumDiscriminator discriminator,
            Cricut_TestAPI_AttributedString_AttributeMergePolicy_new_keepNew keepNew_constructor,
            Cricut_TestAPI_AttributedString_AttributeMergePolicy_extract_keepNew keepNew_extractor,
            Cricut_TestAPI_AttributedString_AttributeMergePolicy_new_keepCurrent keepCurrent_constructor,
            Cricut_TestAPI_AttributedString_AttributeMergePolicy_extract_keepCurrent keepCurrent_extractor,
            out CreatedRef _exn
        );
        ...
        static _TypeSetup() {
            ...
            Once("setup_AttributedStringASDF.AttributeMergePolicy", () => {
                ...
                Utilities.Check((out CreatedRef exn) => TestAPI_AttributedStringASDF_AttributeMergePolicy_setup(
                    bag<FishyJoesRuntime.EnumDiscriminator>((UnownedRef obj, out CreatedRef exn) => Catching(out exn, () => {
                        var enumeration = obj.Peek<Cricut.TestAPI.AttributedString.AttributeMergePolicy>();
                        if (enumeration is Cricut.TestAPI.AttributedString.AttributeMergePolicy.KeepNew) { return (nint)0; }
                        if (enumeration is Cricut.TestAPI.AttributedString.AttributeMergePolicy.KeepCurrent) { return (nint)1; }
                        throw new Exception($"Found unexpected subclass of Cricut.TestAPI.AttributedString.AttributeMergePolicy: {enumeration}");
                    })),
                    bag<Cricut_TestAPI_AttributedString_AttributeMergePolicy_new_keepNew>(
                        (
                            out CreatedRef exn
                        ) => Catching(out exn, () => 
                            new CreatedRef(new Cricut.TestAPI.AttributedString.AttributeMergePolicy.KeepNew(
                            ))
                        )
                    ),
                    bag<Cricut_TestAPI_AttributedString_AttributeMergePolicy_extract_keepNew>(
                        (
                            UnownedRef obj,
                            out CreatedRef exn
                        ) => {
                            try {
                                var enumeration = obj.Peek<Cricut.TestAPI.AttributedString.AttributeMergePolicy.KeepNew>();
                                exn = CreatedRef.Null;
                            } catch (Exception e) {
                                exn = new CreatedRef(e);
                            }
                    ...
                    bag<Cricut_TestAPI_AttributedString_AttributeMergePolicy_new_keepCurrent>(
                        (
                            out CreatedRef exn
                        ) => Catching(out exn, () => 
                            new CreatedRef(new Cricut.TestAPI.AttributedString.AttributeMergePolicy.KeepCurrent(
                            ))
                        )
                    ),
                    bag<Cricut_TestAPI_AttributedString_AttributeMergePolicy_extract_keepCurrent>(
                        (
                            UnownedRef obj,
                            out CreatedRef exn
                        ) => {
                            try {
                                var enumeration = obj.Peek<Cricut.TestAPI.AttributedString.AttributeMergePolicy.KeepCurrent>();
                                exn = CreatedRef.Null;
                            } catch (Exception e) {
                                exn = new CreatedRef(e);
                            }

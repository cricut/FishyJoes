        ...
        static _TypeSetup() {
            ...
            Once("setup_TestAPI.TestAsyncFunctionsStruct", () => {
                ...
                Utilities.Check((out CreatedRef exn) => TestAPI_TestAsyncFunctionsStruct_setup(
                    Loader.env,
                    bag<_TestAPI_TestAsyncFunctionsStructConstructor>((ConsumedRef const42, ConsumedRef iabs, ConsumedRef intCompose, ConsumedRef add3Things, out CreatedRef exn) => Catching(out exn, () => {

...
namespace Cricut.TestAPI {
    ...
    public record DefaultArguments {
        ...
        public static string EchoDefaults(
            ...
            return Check((out CreatedRef _exn) => __cs_TestAPI_DefaultArguments_echoDefaults(_yHandle.ptr, _xHandle.ptr, z, out _exn)).Consume<string>();
        }

        [DllImport("TestAPI-c-sharp", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        private static extern CreatedRef __cs_TestAPI_DefaultArguments_echoDefaults(
            UnownedRef y,
            UnownedRef x,
            double z,
            out CreatedRef exn

...
namespace Cricut.TestAPI {
    ...
    public interface AProtocol {
        ...
        public double HasADefaultImplementation2(
            ...
            return Check((out CreatedRef _exn) => __iota_TestAPI_AProtocol_hasADefaultImplementation2(Loader.env, _thisHandle.ptr, _aHandle.ptr, b, c, out _exn));
        }

        [DllImport("TestAPI-iota", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        private static extern double __iota_TestAPI_AProtocol_hasADefaultImplementation2(
            IntPtr envRef,
            UnownedRef self,
            UnownedRef a,
            bool b,

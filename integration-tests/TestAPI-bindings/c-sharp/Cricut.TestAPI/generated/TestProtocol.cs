...
namespace Cricut.TestAPI {
    ...
    public record TestProtocol {
        ...
        public void Xyzzy(
            ...
            Check((out CreatedRef _exn) => __iota_TestAPI_TestProtocol_xyzzy(Loader.env, _thisHandle.ptr, thud, _graultHandle.ptr, out _exn));
        }

        [DllImport("TestAPI-iota", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        private static extern void __iota_TestAPI_TestProtocol_xyzzy(
            IntPtr envRef,
            UnownedRef self,
            nint thud,
            UnownedRef grault,

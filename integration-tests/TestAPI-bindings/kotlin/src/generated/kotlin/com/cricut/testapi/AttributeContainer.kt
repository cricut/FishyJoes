...
class AttributeContainer private constructor(swiftReference: Long): com.cricut.fishyjoes.runtime.SwiftReference(swiftReference) {
    override fun equals(
        other: Any?
    ): Boolean = (other is com.cricut.testapi.AttributeContainer) && __jni_swiftEquals(this, other)
    ...
    companion object {
        ...
        fun swiftEquals(
            lhs: com.cricut.testapi.AttributeContainer,
            rhs: com.cricut.testapi.AttributeContainer

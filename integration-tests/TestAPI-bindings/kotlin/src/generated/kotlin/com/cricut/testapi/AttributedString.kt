...
class AttributedString private constructor(swiftReference: Long): com.cricut.fishyjoes.runtime.SwiftReference(swiftReference) {
    ...
    class Runs private constructor(swiftReference: Long): com.cricut.fishyjoes.runtime.SwiftReference(swiftReference) {
        ...
        override fun equals(
            other: Any?
        ): Boolean = (other is com.cricut.testapi.AttributedString.Runs) && __jni_swiftEquals(this, other)
        ...
        companion object {
            fun swiftEquals(
                lhs: com.cricut.testapi.AttributedString.Runs,
                rhs: com.cricut.testapi.AttributedString.Runs
            ): Boolean = __jni_swiftEquals(lhs, rhs)
            @JvmStatic
            @JvmName("__jni_swiftEquals")
            private external fun __jni_swiftEquals(
        ...
        class Run private constructor(swiftReference: Long): com.cricut.fishyjoes.runtime.SwiftReference(swiftReference) {
            ...
            override fun equals(
                other: Any?
            ): Boolean = (other is com.cricut.testapi.AttributedString.Runs.Run) && __jni_swiftEquals(this, other)
            ...
            companion object {
                fun swiftEquals(
                    lhs: com.cricut.testapi.AttributedString.Runs.Run,
                    rhs: com.cricut.testapi.AttributedString.Runs.Run
                ): Boolean = __jni_swiftEquals(lhs, rhs)
                @JvmStatic
                @JvmName("__jni_swiftEquals")
                private external fun __jni_swiftEquals(
    ...
    class AttributeMergePolicy private constructor(swiftReference: Long): com.cricut.fishyjoes.runtime.SwiftReference(swiftReference) {
        override fun equals(
            other: Any?
        ): Boolean = (other is com.cricut.testapi.AttributedString.AttributeMergePolicy) && __jni_swiftEquals(this, other)
        ...
        companion object {
            fun swiftEquals(
                lhs: com.cricut.testapi.AttributedString.AttributeMergePolicy,
                rhs: com.cricut.testapi.AttributedString.AttributeMergePolicy
            ): Boolean = __jni_swiftEquals(lhs, rhs)
            @JvmStatic
            @JvmName("__jni_swiftEquals")
            private external fun __jni_swiftEquals(

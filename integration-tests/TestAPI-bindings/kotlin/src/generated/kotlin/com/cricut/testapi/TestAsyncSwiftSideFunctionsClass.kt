...
class TestAsyncSwiftSideFunctionsClass private constructor(_swiftReference: Long): com.cricut.fishyjoes.runtime.SwiftReference(_swiftReference), com.cricut.testapi.TestAsyncFunctions {
    ...
    override fun equals(
        ...
        if (other !is TestAsyncSwiftSideFunctionsClass) {
            return false
        }
        return this.add3Things == other.add3Things && this.const42 == other.const42 && this.fifthThing == other.fifthThing && this.iabs == other.iabs && this.intCompose == other.intCompose && this.makeList == other.makeList && this.six == other.six && this.willThrow == other.willThrow
    }
    ...
    override fun toString(
        ...
        return "TestAsyncSwiftSideFunctionsClass(add3Things = ${add3Things}, const42 = ${const42}, fifthThing = ${fifthThing}, iabs = ${iabs}, intCompose = ${intCompose}, makeList = ${makeList}, six = ${six}, willThrow = ${willThrow})"
    }

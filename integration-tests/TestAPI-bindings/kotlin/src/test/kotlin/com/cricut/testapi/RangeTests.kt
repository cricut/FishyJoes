...
internal class RangeTests {
    ...
    fun testRangeValues() {
        ...
        assertEquals(Ranges.uIntRange, SwiftRange(0x00000000UL, 0xFFFFFFFFUL))
        ...
        assertEquals(Ranges.intRange, SwiftRange(-0x80000000L, 0x7FFFFFFFL))
    }
    ...
    fun testClosedRangeValues() {
        ...
        assertEquals(ClosedRanges.uIntRange, SwiftClosedRange(0x00000000UL, 0xFFFFFFFFUL))
        ...
        assertEquals(ClosedRanges.intRange, SwiftClosedRange(-0x80000000L, 0x7FFFFFFFL))
    ...
    fun testClosedRangeConversion() {
        ...
        assertEquals(ClosedRanges.echoUInt64Range(SwiftClosedRange(uj)), SwiftClosedRange(uj))
        ...
        assertEquals(ClosedRanges.echoInt64Range(SwiftClosedRange(j)), SwiftClosedRange(j))
